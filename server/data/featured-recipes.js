...
const featured = {
    ...
    GENRES: {
        [genres.AFRICAN]: undefined, // TODO: use piriPiriChickenBowl once that's ready
        ...
        [genres.CAJUN]: undefined, // TODO: use jambalaya once that's ready
        [genres.CAMBODIAN]: vietnameseStuffedTomatoes,
        [genres.CHINESE]: chineseLoMeinNoodles, // TODO: use pekingDuck or roastedPorkBelly once that's ready
        ...
        [genres.GERMAN]: undefined,
        [genres.GREEK]: undefined, // TODO: use gyros once that's ready
        ...
        [genres.POLYNESIAN]: undefined,
        [genres.PORTUGUESE]: undefined,

...
module.exports = {
    ...
    separated: false,
    ingredients: [
        { name: 'all-purpose flour', amount: '2 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'baking soda', amount: '1 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'baking powder', amount: '1 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'brown sugar', amount: '1 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'unsalted butter', amount: '1 c', additionalDetails: 'softened', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'oats', amount: '3 c', additionalDetails: 'non-instant', optional: false, section: SECTIONS.MAIN },
        { name: 'raisins', amount: '1 1/2 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
    ],
    appliances: [
        { name: 'oven' },
    ],

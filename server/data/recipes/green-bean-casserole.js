...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...CANNED_GREEN_BEANS, amount: '4 - 14.5 oz', additionalDetails: 'drained', section: CASSEROLE },
        { ...CREAM_OF_MUSHROOM, amount: '10.5 oz can', additionalDetails: '', section: CASSEROLE },
        { ...MILK, amount: '1/2 c', additionalDetails: '', section: CASSEROLE },
        { ...LIGHT_SOY_SAUCE, amount: '1 tsp', additionalDetails: '', section: CASSEROLE },
        { ...BLACK_PEPPER, amount: '1/2 tsp', additionalDetails: '', section: CASSEROLE },
        { ...SALT, amount: '1/4 tsp', additionalDetails: 'to taste', section: CASSEROLE },
        { ...CRISPY_FRIED_ONIONS, amount: '1 c', additionalDetails: '', section: CASSEROLE },

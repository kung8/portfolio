...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2026-03-02 23:11:01',
    modifiedAt: '2026-06-04 19:33:03',
    ...
    directions: [
        ...
        { step: 'Turn heat to medium-high. Bring to a boil (about 20 minutes).', section: SECTIONS.COOK_POTATOES },
        ...
        { step: 'Add beef and onions to the mashed potatoes.', section: SECTIONS.ASSEMBLE, img: croquette1 },
        { step: 'Gently mix.', section: SECTIONS.ASSEMBLE },

        { step: 'Form the mixture into 3 inch long patties.', section: PREP_PATTIES },
        { step: 'Place patties on a tray.', section: PREP_PATTIES, img: croquette2 },
        ...
        { step: 'Place on a tray.', section: SECTIONS.DREDGE, img: croquette3 },

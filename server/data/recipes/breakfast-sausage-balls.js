...
module.exports = {
    ...
    directions: [
        ...
        { step: `In a mixing bowl, combine together all the ingredients besides the milk.`, section: SECTIONS.FORM_BALLS },
        { step: `Add milk 1/4 cup at a time. Mix until incorporated and everything is sticking together.`, section: SECTIONS.FORM_BALLS },
        { step: `Form 3 inch balls.`, section: SECTIONS.FORM_BALLS },

        { step: `Place each ball one inch apart on the baking sheet.`, section: SECTIONS.BAKE, img: balls1 },
        { step: `Bake until the bottoms are browned and cooked through (about 24 to 27 minutes).`, section: SECTIONS.BAKE, img: balls2 },

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...CHICKEN_WINGS, amount: '2 lbs', additionalDetails: '', section: CHICKEN_SECTION },
        { ...SALT, amount: '1 tsp', additionalDetails: '', section: CHICKEN_SECTION },
        { ...BLACK_PEPPER, amount: '1/2 tsp', additionalDetails: '', section: CHICKEN_SECTION },
        { ...UNSALTED_BUTTER, amount: '4 Tbsp', additionalDetails: 'melted', section: COWBOY_BUTTER },
        { ...PARSLEY, amount: '1 Tbsp', additionalDetails: 'finely chopped', section: COWBOY_BUTTER },
        { ...CHIVES, amount: '1 Tbsp', additionalDetails: 'finely chopped', section: COWBOY_BUTTER },
        { ...GARLIC, amount: '1 clove', additionalDetails: 'minced', section: COWBOY_BUTTER },
        { ...DIJON_MUSTARD, amount: '1 tsp', additionalDetails: '', section: COWBOY_BUTTER },
        { ...LEMON_JUICE, amount: '1 tsp', additionalDetails: '', section: COWBOY_BUTTER },
        { ...SMOKED_PAPRIKA, amount: '1 tsp', additionalDetails: '', section: COWBOY_BUTTER },
        { ...SALT, amount: '1/4 tsp', additionalDetails: '', section: COWBOY_BUTTER },
        { ...CAYENNE_PEPPER, amount: '1/8 tsp', additionalDetails: '', section: COWBOY_BUTTER },
    ],
    appliances: [
        { name: 'oven' },
    ],

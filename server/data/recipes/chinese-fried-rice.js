...
const { JASMINE_RICE, COLD_WATER, GREEN_ONIONS, CARROTS, FROZEN_CORN, FROZEN_PEAS, EGGS, SALT, VEGETABLE_OIL, LIGHT_SOY_SAUCE, DARK_SOY_SAUCE, WHITE_SUGAR, CHICKEN_BOUILLON, CHINESE_SAUSAGE } = require('./ingredients');
...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...JASMINE_RICE, amount: '2 c', unit: '', additionalDetails: 'uncooked', section: RICE_SECTION },
        { ...COLD_WATER, amount: '2 c', unit: '', additionalDetails: '', section: RICE_SECTION },

        { ...CARROTS, amount: '2 oz', unit: '', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...FROZEN_CORN, amount: '2 oz', unit: '', additionalDetails: '', section: VEGGIES_SECTION },
        { ...FROZEN_PEAS, amount: '2 oz', unit: '', additionalDetails: '', section: VEGGIES_SECTION },
        { ...COLD_WATER, amount: '1/3 c', unit: '', additionalDetails: '', section: VEGGIES_SECTION },

        { ...LIGHT_SOY_SAUCE, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },
        { ...DARK_SOY_SAUCE, amount: '1 tsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },
        { ...SALT, amount: '1/2 tsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },
        { ...WHITE_SUGAR, amount: '1/2 tsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },
        { ...CHICKEN_BOUILLON, amount: '1 tsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },
        { ...VEGETABLE_OIL, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SAUCE_SECTION },

        { ...EGGS, amount: '4', unit: '', additionalDetails: '', section: EGGS_SECTION },
        { ...SALT, amount: '1/2 tsp', unit: '', additionalDetails: '', section: EGGS_SECTION },
        ...
        { ...VEGETABLE_OIL, amount: '2 Tbsp', unit: '', additionalDetails: '', section: FRIED_RICE_SECTION },
    ],
    appliances: [
        { name: 'rice cooker' },
        { name: 'stove' },

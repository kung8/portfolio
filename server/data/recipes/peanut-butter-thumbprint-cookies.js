...
module.exports = {
    ...
    ingredients: [
        { ...PEANUT_BUTTER, amount: 3 / 4, unit: INGREDIENT_UNITS.CUP, additionalDetails: '', section: SECTIONS.DRY_INGREDIENTS },
        { ...UNSALTED_BUTTER, amount: 1 / 2, unit: INGREDIENT_UNITS.CUP, additionalDetails: 'softened', section: SECTIONS.DRY_INGREDIENTS },
        { ...WHITE_SUGAR, amount: 1 / 2, unit: INGREDIENT_UNITS.CUP, additionalDetails: '', section: SECTIONS.DRY_INGREDIENTS },
        { ...BROWN_SUGAR, amount: 1 / 2, unit: INGREDIENT_UNITS.CUP, additionalDetails: '', section: SECTIONS.DRY_INGREDIENTS },
        { ...SALT, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.DRY_INGREDIENTS },
        { ...EGG, amount: 1, unit: '', additionalDetails: 'room temperature', section: SECTIONS.WET_INGREDIENTS },
    ...
    directions: [
        ...
        { step: `In a stand mixer, cream the "${SECTIONS.DRY_INGREDIENTS}" section ingredients until combined.`, section: SECTIONS.MAKE_DOUGH, img: [cookies1, cookies2] },
        ...
        { step: `Form 1 inch balls and place on baking sheet 2 inches apart.`, section: SECTIONS.FORM_BALLS, img: cookies5 },

        { step: `Bake until cookies are puffy (for about 8 to 10 minutes).`, section: SECTIONS.BAKE, img: cookies6 },
        { step: `Immediately add and press kisses to the center of the cookie.`, section: SECTIONS.COOL, img: cookies7 },
        { step: `Let cookies cool completely on the pan.`, section: SECTIONS.COOL },

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'ground beef', amount: '1 lb', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'medium-sized frito chips', amount: '1 bag', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'taco seasoning', amount: '', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'black bean', amount: '8 oz', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'corn', amount: '8 oz', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'tomato', amount: '', additionalDetails: 'diced', optional: false, section: SECTIONS.TOPPINGS },
        { name: 'green bell peppers', amount: '', additionalDetails: 'diced', optional: false, section: SECTIONS.TOPPINGS },
        { name: 'sour cream', amount: '', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },

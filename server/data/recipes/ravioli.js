...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...ALL_PURPOSE_FLOUR, amount: '2/3 c', additionalDetails: '', section: PASTA_SECTIONS },
        { ...DURUM_WHEAT, amount: '2/3 c', additionalDetails: '', section: PASTA_SECTIONS },
        { ...EGGS, amount: '3', additionalDetails: '', section: PASTA_SECTIONS },

        { ...RICOTTA_CHEESE, amount: '18 oz', additionalDetails: '', section: FILLING_SECTIONS },
        { ...EGGS, amount: '2', additionalDetails: '', section: FILLING_SECTIONS },
        { ...PARMIGIANO_REGGIANO, amount: '3 Tbsp', additionalDetails: '', section: FILLING_SECTIONS },
        { ...SALT, amount: '2 tsp', additionalDetails: '', section: FILLING_SECTIONS },
        { ...BLACK_PEPPER, amount: '1 Tbsp', additionalDetails: '', section: FILLING_SECTIONS },

        { ...UNSALTED_BUTTER, amount: '4 Tbsp', additionalDetails: '', section: SAUCE_SECTIONS },
        { ...FRESH_SAGE, amount: '', additionalDetails: '', section: SAUCE_SECTIONS },
        { ...PARMIGIANO_REGGIANO, amount: '6 Tbsp', additionalDetails: '', section: SAUCE_SECTIONS },
    ],
    appliances: [
        { name: 'refrigerator' },
        { name: 'stove' },

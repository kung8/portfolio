...
module.exports = {
    ...
    ingredients: [
        { name: 'chicken thigh', amount: '3 lb', additionalDetails: 'cut into 2 - 2.5" pieces', section: SECTIONS.MARINADE },
        { name: 'garlic', amount: '3 cloves', additionalDetails: 'minced', section: SECTIONS.MARINADE },
        { name: 'ginger', amount: '1/2 tsp', additionalDetails: 'grated', section: SECTIONS.MARINADE },
        { name: 'sea salt', amount: '2 tsp', additionalDetails: '', section: SECTIONS.MARINADE },
        { name: 'mirin', amount: '1 Tbsp', additionalDetails: '', section: SECTIONS.MARINADE },

        { name: 'vegetable oil', amount: '', additionalDetails: 'for frying', section: SECTIONS.MAIN },

        { name: 'flour/cornstarch/potato starch', amount: '2 c', additionalDetails: '', section: SECTIONS.DRY_RUB },
        { name: 'baking powder', amount: '1 tsp', additionalDetails: '', section: SECTIONS.DRY_RUB },

        { name: 'water', amount: '2 1/2 c', additionalDetails: '', section: SECTIONS.WET_RUB },
        { name: 'cornstarch', amount: '1 1/4 c', additionalDetails: '', section: SECTIONS.WET_RUB },
        { name: 'flour', amount: '1 1/4 c', additionalDetails: '', section: SECTIONS.WET_RUB },
        { name: 'baking powder', amount: '1 tsp', additionalDetails: '', section: SECTIONS.WET_RUB },
        { name: 'cornstarch', amount: '2 c', additionalDetails: '', section: SECTIONS.WET_RUB },

        { name: 'honey', amount: '1/4 c', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { name: 'soy sauce', amount: '1/4 c', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { name: 'garlic', amount: '3 cloves', additionalDetails: 'minced', section: SWEET_AND_TANGY_SAUCE },
        { name: 'ginger', amount: '1/2 tsp', additionalDetails: 'grated', section: SWEET_AND_TANGY_SAUCE },
        { name: 'rice wine vinegar', amount: '3 Tbsp', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { name: 'hoisin sauce', amount: '2 Tbsp', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { name: 'sesame oil', amount: '1 Tbsp', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },

        { name: 'gochujang', amount: '1/4 c', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'sugar', amount: '1/4 c', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'strawberry jam', amount: '3 Tbsp', additionalDetails: 'seedless', section: SWEET_AND_SPICY_SAUCE },
        { name: 'soy sauce', amount: '2 1/2 Tbsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'rice wine vinegar', amount: '1 1/2 Tbsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'honey', amount: '1 Tbsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'ketchup', amount: '1 Tbsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'water', amount: '6 Tbsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'garlic', amount: '2 cloves', additionalDetails: 'minced', section: SWEET_AND_SPICY_SAUCE },
        { name: 'ginger', amount: '1/2 tsp', additionalDetails: 'grated', section: SWEET_AND_SPICY_SAUCE },
        { name: 'salt', amount: '1/2 tsp', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { name: 'thai chili peppers', amount: '2', additionalDetails: 'optional and minced', section: SWEET_AND_SPICY_SAUCE },
    ],
    appliances: [
        { name: 'stove' },
    ],

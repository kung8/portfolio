...
module.exports = {
    ...
    ingredients: [
        { ...CHICKEN_THIGH, amount: 3, unit: UNITS.POUND, additionalDetails: 'cut into 2 - 2.5" pieces', section: SECTIONS.MARINADE },
        { ...GARLIC, amount: 3, unit: UNITS.CLOVE, additionalDetails: 'minced', section: SECTIONS.MARINADE },
        { ...GINGER, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: 'grated', section: SECTIONS.MARINADE },
        { ...SALT, amount: 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.MARINADE },
        { ...MIRIN, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: SECTIONS.MARINADE },

        { ...VEGETABLE_OIL, amount: '', unit: '', additionalDetails: 'for frying', section: SECTIONS.MAIN },

        { ...ALL_PURPOSE_FLOUR, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.DRY_RUB },
        { ...BAKING_POWDER, amount: 1, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.DRY_RUB },

        { ...WARM_WATER, amount: 5 / 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...CORNSTARCH, amount: 5 / 4, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...ALL_PURPOSE_FLOUR, amount: 5 / 4, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...BAKING_POWDER, amount: 1, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...CORNSTARCH, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.WET_RUB },

        { ...HONEY, amount: 1 / 4, unit: UNITS.CUP, additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...LIGHT_SOY_SAUCE, amount: 1 / 4, unit: UNITS.CUP, additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...GARLIC, amount: 3, unit: UNITS.CLOVE, additionalDetails: 'minced', section: SWEET_AND_TANGY_SAUCE },
        { ...GINGER, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: 'grated', section: SWEET_AND_TANGY_SAUCE },
        { ...RICE_WINE_VINEGAR, amount: 3, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...HOISIN_SAUCE, amount: 2, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...SESAME_OIL, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },

        { ...GOCHUJANG_SAUCE, amount: 1 / 4, unit: UNITS.CUP, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...WHITE_SUGAR, amount: 1 / 4, unit: UNITS.CUP, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...STRAWBERRY_JAM, amount: 3, unit: UNITS.TABLESPOON, additionalDetails: 'seedless', section: SWEET_AND_SPICY_SAUCE },
        { ...LIGHT_SOY_SAUCE, amount: 5 / 2, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...RICE_WINE_VINEGAR, amount: 3 / 2, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...HONEY, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...KETCHUP, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...WARM_WATER, amount: 6, unit: UNITS.TABLESPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...GARLIC, amount: 2, unit: UNITS.CLOVE, additionalDetails: 'minced', section: SWEET_AND_SPICY_SAUCE },
        { ...GINGER, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: 'grated', section: SWEET_AND_SPICY_SAUCE },
        { ...SALT, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },

...
module.exports = {
    ...
    ingredients: [
        { ...CHICKEN_THIGH, amount: '3 lb', unit: '', additionalDetails: 'cut into 2 - 2.5" pieces', section: SECTIONS.MARINADE },
        { ...GARLIC, amount: '3 cloves', unit: '', additionalDetails: 'minced', section: SECTIONS.MARINADE },
        { ...GINGER, amount: '1/2 tsp', unit: '', additionalDetails: 'grated', section: SECTIONS.MARINADE },
        { ...SALT, amount: '2 tsp', unit: '', additionalDetails: '', section: SECTIONS.MARINADE },
        { ...MIRIN, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.MARINADE },

        { ...VEGETABLE_OIL, amount: '', unit: '', additionalDetails: 'for frying', section: SECTIONS.MAIN },

        { ...ALL_PURPOSE_FLOUR, amount: '2 c', unit: '', additionalDetails: '', section: SECTIONS.DRY_RUB },
        { ...BAKING_POWDER, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.DRY_RUB },

        { ...WARM_WATER, amount: '2 1/2 c', unit: '', additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...CORNSTARCH, amount: '1 1/4 c', unit: '', additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...ALL_PURPOSE_FLOUR, amount: '1 1/4 c', unit: '', additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...BAKING_POWDER, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.WET_RUB },
        { ...CORNSTARCH, amount: '2 c', unit: '', additionalDetails: '', section: SECTIONS.WET_RUB },

        { ...HONEY, amount: '1/4 c', unit: '', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...LIGHT_SOY_SAUCE, amount: '1/4 c', unit: '', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...GARLIC, amount: '3 cloves', unit: '', additionalDetails: 'minced', section: SWEET_AND_TANGY_SAUCE },
        { ...GINGER, amount: '1/2 tsp', unit: '', additionalDetails: 'grated', section: SWEET_AND_TANGY_SAUCE },
        { ...RICE_WINE_VINEGAR, amount: '3 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...HOISIN_SAUCE, amount: '2 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },
        { ...SESAME_OIL, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_TANGY_SAUCE },

        { ...GOCHUJANG_SAUCE, amount: '1/4 c', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...WHITE_SUGAR, amount: '1/4 c', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...STRAWBERRY_JAM, amount: '3 Tbsp', unit: '', additionalDetails: 'seedless', section: SWEET_AND_SPICY_SAUCE },
        { ...LIGHT_SOY_SAUCE, amount: '2 1/2 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...RICE_WINE_VINEGAR, amount: '1 1/2 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...HONEY, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...KETCHUP, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...WARM_WATER, amount: '6 Tbsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },
        { ...GARLIC, amount: '2 cloves', unit: '', additionalDetails: 'minced', section: SWEET_AND_SPICY_SAUCE },
        { ...GINGER, amount: '1/2 tsp', unit: '', additionalDetails: 'grated', section: SWEET_AND_SPICY_SAUCE },
        { ...SALT, amount: '1/2 tsp', unit: '', additionalDetails: '', section: SWEET_AND_SPICY_SAUCE },

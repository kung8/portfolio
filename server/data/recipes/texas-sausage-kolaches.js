...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Add the remaining "Sugar Mixture" section ingredients. Stir until sugar is dissolved.', type: PREP_SUGAR_MIXTURE, img: kolaches1 },
        { step: 'Let the sugar mixture come to room temperature (about 10 minutes).', type: PREP_SUGAR_MIXTURE, img: kolaches2 },

        { step: 'In a stand mixer, combine "Yeast Mixture". Stir until dissolved.', type: PREP_YEAST_MIXTURE, img: kolaches3 },

        { step: 'Add 2 cups of flour, sugar mixture, and eggs. Beat with a dough hook attachment until smooth.', type: MAKE_DOUGH, img: [kolaches4, kolaches5] },
        { step: 'Slowly add remaining flour while mixing until dough just becomes elastic and a little firm (not dry).', type: MAKE_DOUGH, img: [kolaches6, kolaches7] },
        ...
        { step: 'Cut the cheese thinly to match the length of the halved sausage.', type: PREP_FILLING, img: kolaches8 },
        ...
        { step: 'Flatten into discs and fill each with sausage and cheese.', type: BAKE_KOLACHES, img: [kolaches9, kolaches10] },
        { step: 'Fold dough around filling and pinch edges.', type: BAKE_KOLACHES },
        { step: 'Place kolaches on the baking sheet with the seam-side down.', type: BAKE_KOLACHES, img: kolaches11 },
        { step: 'Brush tops with melted butter.', type: BAKE_KOLACHES, img: kolaches12 },
        { step: 'Bake until golden brown (about 12 to 15 minutes).', type: BAKE_KOLACHES, img: kolaches13 },

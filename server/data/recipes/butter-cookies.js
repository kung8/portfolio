...
const { ALL_PURPOSE_FLOUR, BAKING_SHEET, CRYSTAL_SUGAR, EGG_YOLK, OVEN, PLASTIC_WRAP, SALT, SILICONE_BAKING_MAT, STAND_MIXER, UNSALTED_BUTTER, VANILLA_EXTRACT, WHITE_SUGAR } = require('./ingredients');
...
module.exports = {
    wip: true,
    cardName: 'Butter Cookies',
    name: 'Butter Cookies',
    img: '',
    available: true,
    recommended: false,
    createdAt: '2026-04-05 02:09:28',
    modifiedAt: '2026-04-05 02:09:28',
    category: [CATEGORIES.DESSERT],
    genre: [GENRES.AMERICAN],
    method: [METHODS.BAKE],
    type: [TYPES.COOKIE, TYPES.DESSERT],
    yields: { amount: 16, unit: YIELD_UNITS.EACH },
    ...
    websites: [
        {
            ...
            link: 'https://preppykitchen.com/butter-cookies/',
            authors: ['John Kanell'],
            finder: 'Kevin Ung',
        },
    ],
    ingredients: [
        ...
        { ...CRYSTAL_SUGAR, amount: 1 / 3, unit: INGREDIENT_UNITS.CUP, additionalDetails: '', section: SECTIONS.COATING },
    ],
    appliances: [
        STAND_MIXER,
        OVEN,
    ...
    directions: [
        ...
        { step: `Sprinkle crystal sugar on counter. Roll dough in sugar until dough is coated.`, section: FORM_COOKIES },
        { step: `Cut chilled dough into slices (about 3/4 inch thick).`, section: FORM_COOKIES },
        { step: `Place cookies on lined baking sheet about an inch apart.`, section: FORM_COOKIES },
        ...
        { step: `Enjoy these cookies!`, section: SECTIONS.SERVE },
    ],
    store: [
        {

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...CHICKEN_BREAST, amount: 6, unit: UNITS.PIECE, additionalDetails: '', section: SECTIONS.MAIN },
        { ...CHICKEN_BROTH, amount: 4, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.MAIN },
        { ...CREAM_OF_CHICKEN, amount: 21, unit: UNITS.OUNCE, additionalDetails: '', section: SECTIONS.MAIN },
        { ...CREAM_CHEESE, amount: 1 / 4, unit: UNITS.CUP, additionalDetails: 'cubed', section: SECTIONS.MAIN },
        ...
        { ...GREEN_BELL_PEPPERS, amount: 2, unit: '', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...YELLOW_ONION, amount: 1 / 2, unit: UNITS.LARGE, additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...GREEN_ONIONS, amount: 1, unit: UNITS.BUNCH, additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...ROMA_TOMATO, amount: 2, unit: '', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...PINEAPPLE, amount: 12, unit: UNITS.OUNCE, additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SLICED_ALMONDS, amount: 1 / 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SHREDDED_COCONUT, amount: 1 / 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SOUR_CREAM, amount: 8, unit: UNITS.OUNCE, additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...CHOW_MEIN_NOODLES, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'slow cooker' },
    ],

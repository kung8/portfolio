...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'chicken broth', amount: '4 cup', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'cream of chicken', amount: '2 - 10.5 oz can of', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'cream cheese', amount: '1/4 cup', additionalDetails: 'cubed', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'sliced almonds', amount: '1/2 cup', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },
        { name: 'shredded coconut', amount: '1/2 cup', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },
        { name: 'sour cream', amount: '8 oz', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },
        { name: 'chow mein noodles', amount: '2 cups', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },
    ],
    supplies: [
        { name: 'slow cooker' },

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'large chicken breast', amount: '5 - 6', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'chicken broth', amount: '4 c', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'cream of chicken', amount: '2 - 10.5 oz can of', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'cream cheese', amount: '1/4 c', additionalDetails: 'cubed', section: SECTIONS.MAIN },
        { name: 'salt', amount: '', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'pepper', amount: '', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'basil', amount: '', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'oregano', amount: '', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'rice', amount: '', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'green peppers', amount: '2', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { name: 'large onion', amount: '1/2', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { name: 'green onion', amount: 'bunch', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { name: 'roma tomato', amount: '2', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { name: 'pineapple tidbit', amount: '12 oz can', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { name: 'sliced almonds', amount: '1/2 c', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { name: 'shredded coconut', amount: '1/2 c', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { name: 'sour cream', amount: '8 oz', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { name: 'chow mein noodles', amount: '2 c', additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'slow cooker' },
    ],

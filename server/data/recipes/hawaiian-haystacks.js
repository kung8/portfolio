...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...CHICKEN_BREAST, amount: '5 - 6', unit: '', additionalDetails: '', section: SECTIONS.MAIN },
        { ...CHICKEN_BROTH, amount: '4 c', unit: '', additionalDetails: '', section: SECTIONS.MAIN },
        { ...CREAM_OF_CHICKEN, amount: '2 - 10.5 oz can of', unit: '', additionalDetails: '', section: SECTIONS.MAIN },
        { ...CREAM_CHEESE, amount: '1/4 c', unit: '', additionalDetails: 'cubed', section: SECTIONS.MAIN },
        ...
        { ...YELLOW_ONION, amount: '1/2 large', unit: '', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...GREEN_ONIONS, amount: 'bunch', unit: '', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...ROMA_TOMATO, amount: '2', unit: '', additionalDetails: 'diced', section: SECTIONS.TOPPINGS },
        { ...PINEAPPLE, amount: '12 oz can', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SLICED_ALMONDS, amount: '1/2 c', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SHREDDED_COCONUT, amount: '1/2 c', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...SOUR_CREAM, amount: '8 oz', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...CHOW_MEIN_NOODLES, amount: '2 c', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'slow cooker' },
    ],

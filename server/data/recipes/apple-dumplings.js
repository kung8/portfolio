...
const { APPLE, BAKING_PAN, CINNAMON, OVEN, REFRIGERATED_BISCUIT_DOUGH, SMALL_BOWL, UNSALTED_BUTTER, VANILLA_EXTRACT, WATER, WHITE_SUGAR } = require('./ingredients');

...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-12-28 13:39:44',
    modifiedAt: '2026-06-04 18:43:00',
    ...
    directions: [
        ...
        { step: `In a medium bowl, combine the "Seasoning" ingredients. Mix until everything is dissolved.`, section: PREP_SEASONINGS },
        { step: `In a mixing bowl, combine the sliced chicken and the shaoxing wine. Let it marinate for 5 minutes.`, section: PREP_CHICKEN },
        { step: `In a medium bowl, crack eggs. Do not beat.`, section: CUT_EGGS },
        { step: `Use a pair of chopsticks to break up the clumps of egg whites by lifting those parts up. If the yolks break it is fine, just avoid blending the yolk and whites together.`, section: CUT_EGGS },
        { step: `In a frying pan, add onions in a single layer.`, section: COOK_OYAKODON },
        { step: `Add the seasoning mixture to just cover the onions. If not, add more seasoning or use a smaller pan.`, section: COOK_OYAKODON },
        { step: `Turn on stove to medium heat and bring to a simmer.`, section: COOK_OYAKODON },
        { step: `Add the chicken evenly on top of the onions. Bring to a simmer.`, section: COOK_OYAKODON },
        { step: `Lower to medium-low heat. Cook until chicken is no longer pink and onions are tender (for about 5 minutes). Flip the chicken about halfway through.`, section: COOK_OYAKODON },
        ...
        { step: `Once the eggs begins to set, pour the remaining egg to the center and around the edges.`, section: COOK_OYAKODON, img: [oyakodon1, oyakodon4] },
        { step: `Add the green onions to the top. Cook over medium-low heat until eggs are cooked to desired doneness.`, section: COOK_OYAKODON },
        { step: `Serve this over rice with the sauce. Enjoy the simple taste of Japanese cuisine.`, section: SECTIONS.SERVE, img: oyakodon3 },
    ],
    store: [
        {
            ...
            instructions: 'Store the oyakodon and rice separately. When ready to eat, reheat the oyakodon in a pan and serve over the reheated rice.',
        },
    ],
    reheat: [
        {
            method: REHEAT_METHODS.SIMMER,
            instruction: 'Over medium-low heat, reheat the oyakodon in a pan until warmed through. Serve over reheated rice.',
        },
        {
            method: REHEAT_METHODS.MICROWAVE,
            instruction: 'If oyakodon and rice are combined, microwave until warmed through (about 2 to 3 minutes).',
        },
    ],
    mealPrep: false,
};
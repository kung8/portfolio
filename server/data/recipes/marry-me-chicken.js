...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Prepare chicken by removing any fat and pat dry.', type: SECTIONS.CHICKEN, img: chicken3 },
        ...
        { step: 'Add cream and mix.', type: SUN_DRIED_TOMATO_CREAM_SAUCE, img: sauce5 },
        { step: 'Add cheese and stir until the cheese melts.', type: SUN_DRIED_TOMATO_CREAM_SAUCE, img: sauce6 },
        { step: 'Move pot back to burner and stir for a minute (while the pot returns to heat).', type: SUN_DRIED_TOMATO_CREAM_SAUCE, img: sauce8 },
        { step: 'Add sun-dried tomatoes, oregano and red pepper flakes. Stir.', type: SUN_DRIED_TOMATO_CREAM_SAUCE, img: sauce11 },
        ...
        { step: 'Carefully remove pot from oven and spoon sauce over chicken.', type: SUN_DRIED_TOMATO_CREAM_SAUCE, img: combined3 },
        ...
        { step: 'Serve with your favorite sides and be sure to ladle sauce over the chicken.', type: SECTIONS.SERVE, img: plated3 },
    ]
};
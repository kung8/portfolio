...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-11-21 19:03:30',
    modifiedAt: '2026-06-01 22:31:54',
    ...
    directions: [
        { step: `Preheat the oven to 375ºF. Arrange the rack so the dutch oven pot will be cooked in the center of the oven.`, section: SECTIONS.PREHEAT_OVEN },
        { step: `Prepare chicken by removing any fat and pat dry.`, section: SECTIONS.CHICKEN },
        { step: `Season with salt and pepper generously on both sides.`, section: SECTIONS.CHICKEN },
        { step: `Over medium-high heat, add olive oil and spread until covered.`, section: SECTIONS.CHICKEN },
        { step: `Sear chicken until lightly golden (about 3 to 4 minutes).`, section: SECTIONS.CHICKEN },
        { step: `Flip and sear the other side (about 3 to 4 minutes).`, section: SECTIONS.CHICKEN },
        { step: `Transfer chicken to plate (chicken should not be cooked all the way through).`, section: SECTIONS.CHICKEN },

        { step: `Reduce to medium-low heat and wait until dutch oven pot cools.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Add garlic. Saute until fragrant (about 1 to 2 minutes).`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Add broth and deglaze the pan.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Remove pan from heat.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Add cream and mix.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Add cheese and stir until the cheese melts.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Move pot back to burner and stir for a minute (while the pot returns to heat).`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Add sun-dried tomatoes, oregano and red pepper flakes. Stir.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Taste sauce and adjust with seasoning as needed.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Simmer over medium-low heat and stir occasionally.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Once simmering, add chicken and flip several times until the chicken is coated.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE, img: chicken1 },
        { step: `Transfer the pot to the oven.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Bake until the chicken reaches 160ºF (about 12 to 15 minutes).`, section: SUN_DRIED_TOMATO_CREAM_SAUCE },
        { step: `Carefully remove pot from oven and spoon sauce over chicken.`, section: SUN_DRIED_TOMATO_CREAM_SAUCE, img: chicken2 },
        ...
        { step: `Serve with your favorite sides and be sure to ladle sauce over the chicken.`, section: SECTIONS.SERVE, img: chicken3 },
    ],
    store: [
        {

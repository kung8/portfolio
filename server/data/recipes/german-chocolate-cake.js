...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '10/26/2025 22:16:17',
    modifiedAt: '06/02/2026 20:57:22',
    ...
    directions: [
        ...
        { step: `Add the wet ingredients to the dry ingredients. Mix.`, section: SECTIONS.PREP_BATTER },
        { step: `Slowly stir in the boiling water.`, section: SECTIONS.PREP_BATTER },
        { step: `Pour batter into baking pans.`, section: SECTIONS.PREP_BATTER },

        { step: `Bake until an inserted toothpick comes out clean (about 25 to 35 minutes).`, section: SECTIONS.BAKE },

        { step: `Cool for 5 minutes in the pan.`, section: SECTIONS.COOL },
        { step: `Transfer to wire rack by just inverting it. Let it completely cool.`, section: SECTIONS.COOL },

        { step: `In a saucepan, combine "${COCONUT_FROSTING_HEATED_INGREDIENTS_SECTION}" section ingredients.`, section: COOK_COCONUT_FROSTING },
        { step: `Over medium heat, bring the sauce to a low boil. Stir constantly until mixture begins to thicken.`, section: COOK_COCONUT_FROSTING },
        { step: `Remove saucepan from heat.`, section: COOK_COCONUT_FROSTING },
        { step: `Add the "${COCONUT_FROSTING_ADDITIONAL_INGREDIENTS_SECTION}" section ingredients. Stir.`, section: COOK_COCONUT_FROSTING },
        { step: `Let it completely cool.`, section: COOK_COCONUT_FROSTING, img: cake1 },

        { step: `In a microwavable mixing bowl, melt butter.`, section: COOK_CHOCOLATE_BUTTERCREAM_FROSTING },
        { step: `Stir in cocoa powder.`, section: COOK_CHOCOLATE_BUTTERCREAM_FROSTING },
        { step: `Alternate adding powdered sugar and milk. Beat as added.`, section: COOK_CHOCOLATE_BUTTERCREAM_FROSTING },
        { step: `Add vanilla. Mix.`, section: COOK_CHOCOLATE_BUTTERCREAM_FROSTING, img: cake2 },

        { step: `Place one cake layer on your serving plate.`, section: SECTIONS.ASSEMBLE },
        { step: `Spread a thin layer of chocolate frosting.`, section: SECTIONS.ASSEMBLE, img: cake3 },
        { step: `Spread half the coconut frosting.`, section: SECTIONS.ASSEMBLE, img: cake4 },
        { step: `Place the second cake layer.`, section: SECTIONS.ASSEMBLE, img: cake5 },
        { step: `Spread chocolate frosting all over.`, section: SECTIONS.ASSEMBLE, img: cake6 },

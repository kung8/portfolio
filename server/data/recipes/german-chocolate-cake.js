...
const { WHITE_SUGAR, ALL_PURPOSE_FLOUR, COCOA_POWDER, BAKING_POWDER, BAKING_SODA, SALT, EGG, BUTTERMILK, VEGETABLE_OIL, VANILLA_EXTRACT, WATER, BROWN_SUGAR, UNSALTED_BUTTER, EGG_YOLK, EVAPORATED_MILK, PECANS, SHREDDED_COCONUT, POWDERED_SUGAR, OVEN, STOVE, CAKE_PAN, PARCHMENT_PAPER, MIXING_BOWL, SAUCEPAN, COOLING_RACK, MEDIUM_BOWL } = require('./ingredients');

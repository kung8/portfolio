...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Tie together the "Herb Bundle" section ingredients with kitchen twine.', section: BUNDLE_HERBS },

        { step: 'Add the bundled herbs and the "Broth" section ingredients.', section: MAKE_SOUP },
        { step: 'Lower to medium heat. Simmer and stir occasionally for 20 minutes.', section: MAKE_SOUP },
        { step: 'Lower to low heat. Remove the herb bundle.', section: MAKE_SOUP },
        { step: 'Add vinegar, salt and pepper. Stir and cover.', section: MAKE_SOUP },
        ...
        { step: 'Arrange 4 oven-safe bowls on a baking pan. Fill bowls up to 2/3 with soup.', section: BAKE_SOUP },
        { step: 'Top each bowl with toasted bread, 2 Gruyere cheese slices, 1/4 of Asiago cheese, and paprika.', section: BAKE_SOUP },
        { step: 'Broil until bubbly and golden brown (about 5 minutes).', section: BAKE_SOUP },

...
const { BLACK_PEPPER, BLENDER, CHICKEN_BROTH, CILANTRO, EGG, GARLIC, GARLIC_POWDER, GROUND_BEEF, LARGE_POT, MEDIUM_BOWL, MIXING_BOWL, SALT, SMALL_BOWL, STOVE, VEGETABLE_OIL, VINE_TOMATO, WHITE_ONION, WHITE_RICE, ZUCCHINI } = require('./ingredients');

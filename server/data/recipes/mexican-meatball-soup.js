...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...WHITE_RICE, amount: '1 c', additionalDetails: '', section: MEATBALLS },
        { ...GROUND_BEEF, amount: '1 lb', additionalDetails: '', section: MEATBALLS },
        { ...ZUCCHINI, amount: '1', additionalDetails: 'grated', section: MEATBALLS },
        { ...WHITE_ONION, amount: '1/4 medium', additionalDetails: 'chopped', section: MEATBALLS },
        { ...EGGS, amount: '1', additionalDetails: 'beaten', section: MEATBALLS },
        { ...GARLIC_POWDER, amount: '1/3 tsp', additionalDetails: '', section: MEATBALLS },
        { ...BLACK_PEPPER, amount: '1/2 tsp', additionalDetails: '', section: MEATBALLS },
        { ...SALT, amount: '', additionalDetails: 'to taste', section: MEATBALLS },


        { ...VINE_TOMATOES, amount: '1 lb', additionalDetails: '', section: TOMATO_BROTH },
        { ...GARLIC, amount: '1 clove', additionalDetails: '', section: TOMATO_BROTH },
        { ...VEGETABLE_OIL, amount: '1 Tbsp', additionalDetails: '', section: TOMATO_BROTH },
        { ...WHITE_ONION, amount: '1/4 medium', additionalDetails: '', section: TOMATO_BROTH },
        { ...CHICKEN_BROTH, amount: '4 c', additionalDetails: '', section: TOMATO_BROTH },

        { ...CILANTRO, amount: '1/2 c', additionalDetails: 'chopped', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
        { name: 'blender' },

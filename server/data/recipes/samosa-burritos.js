...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...TORTILLA, amount: '8', additionalDetails: '', section: '' },
        { ...CAULIFLOWER, amount: '2 c', additionalDetails: 'chopped', section: VEGETABLES_SECTION },
        { ...POTATOES, amount: '2 c', additionalDetails: 'chopped', section: VEGETABLES_SECTION },
        { ...RED_ONION, amount: '1 small', additionalDetails: 'diced', section: VEGETABLES_SECTION },
        { ...JALAPENO_PEPPERS, amount: '1', additionalDetails: 'diced', section: VEGETABLES_SECTION },
        { ...VEGETABLE_BROTH, amount: '1 Tbsp', additionalDetails: '', section: VEGETABLES_SECTION },

        { ...GARLIC, amount: '4 cloves', additionalDetails: 'minced', section: HERBS_SECTION },
        { ...GINGER, amount: '2 tsp', additionalDetails: '', section: HERBS_SECTION },
        { ...CUMIN, amount: '1/2 tsp', additionalDetails: '', section: HERBS_SECTION },
        { ...CORIANDER, amount: '1/2 tsp', additionalDetails: '', section: HERBS_SECTION },
        { ...GARAM_MASALA, amount: '1 tsp', additionalDetails: '', section: HERBS_SECTION },
        { ...FENNEL_SEEDS, amount: '1/2 tsp', additionalDetails: '', section: HERBS_SECTION },
        { ...TURMERIC, amount: '1/4 tsp', additionalDetails: '', section: HERBS_SECTION },

        { ...LEMON_JUICE, amount: '1 Tbsp', additionalDetails: '', section: PEAS_SECTION },
        { ...FROZEN_PEAS, amount: '1 c', additionalDetails: '', section: PEAS_SECTION },
        { ...SEA_SALT, amount: '3/4 tsp', additionalDetails: '', section: PEAS_SECTION },
        { ...BLACK_PEPPER, amount: '1/2 tsp', additionalDetails: '', section: PEAS_SECTION },

        { ...GREEK_YOGURT, amount: '1 c', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...MINT_LEAVES, amount: '1/4 c', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...CILANTRO, amount: '1/2 c', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...JALAPENO_PEPPERS, amount: '1', additionalDetails: 'seeded', section: CHUTNEY_SECTION },
        { ...GINGER, amount: '2 tsp', additionalDetails: 'grated', section: CHUTNEY_SECTION },
        { ...GARLIC, amount: '2 cloves', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...MAPLE_SYRUP, amount: '2 tsp', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...LIME_JUICE, amount: '1 Tbsp', additionalDetails: '', section: CHUTNEY_SECTION },
        { ...SEA_SALT, amount: '1/4 tsp', additionalDetails: '', section: CHUTNEY_SECTION },
    ],
    appliances: [
        { name: 'oven' },
        { name: 'stove' },

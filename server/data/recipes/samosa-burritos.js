...
const { ALUMINUM_FOIL, BAKING_PAN, BAKING_SHEET, BLACK_PEPPER, BLENDER, CAULIFLOWER, CILANTRO, CORIANDER, CUMIN, FENNEL_SEEDS, FROZEN_PEAS, GARAM_MASALA, GARLIC, GINGER, GINGER_PUREE, GREEK_YOGURT, JALAPENO_PEPPER, KITCHEN_TOWEL, LARGE_PAN, LARGE_POT, LEMON_JUICE, LIME_JUICE, MAPLE_SYRUP, MINT_LEAF, OVEN, PARCHMENT_PAPER, POTATO, RED_ONION, SEA_SALT, STOVE, TORTILLA, TURMERIC, VEGETABLE_BROTH } = require('./ingredients');

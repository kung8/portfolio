...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'yellow mustard', amount: '2 1/2 T', additionalDetails: '', optional: false },
        { name: 'salt (+ for boiling)', amount: '1 1/2 t', additionalDetails: '', optional: false },
        { name: 'pepper', amount: '1/2 t', additionalDetails: '', optional: false },

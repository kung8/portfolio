...
module.exports = {
    ...
    ingredients: [
        { ...GHEE, amount: '2 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...YELLOW_ONION, amount: '1 medium', unit: '', additionalDetails: 'diced', section: SECTIONS.SAUCE },
        { ...GARLIC, amount: '4 cloves', unit: '', additionalDetails: 'minced', section: SECTIONS.SAUCE },
        { ...CUMIN, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...SALT, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...GINGER, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...CAYENNE_PEPPER, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...CINNAMON, amount: '1/2 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...TURMERIC, amount: '1/4 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...TOMATO_SAUCE, amount: '14 oz', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...HEAVY_CREAM, amount: '1 c', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...WHITE_SUGAR, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...PAPRIKA, amount: '2 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...VEGETABLE_OIL, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '4', unit: '', additionalDetails: '1 inch pieces', section: SECTIONS.CHICKEN },
        { ...CURRY_POWDER, amount: '1/2 tsp', unit: '', additionalDetails: '', section: SECTIONS.CHICKEN },
    ],
    appliances: [
        { name: 'stove' },
    ],

...
const INGREDIENTS = {
    APPLIANCES: {
        ...
        BROILER: { name: 'broiler', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        DEEP_FRYER: { name: 'deep fryer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        DEEP_FRYER_OR_STOVE: { name: 'deep fryer or stove', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        DISHWASHER: { name: 'dishwasher', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        FOOD_PROCESSOR: { name: 'food processor', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        FREEZER: { name: 'freezer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        GRIDDLE: { name: 'griddle', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        GRILL: { name: 'grill', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        GRILL_OR_STOVE: { name: 'grill or stove', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ICE_CREAM_MAKER: { name: 'ice cream maker', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        MICROWAVE: { name: 'microwave', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        OVEN: { name: 'oven', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        PASTA_MAKER: { name: 'pasta maker', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        REFRIGERATOR: { name: 'refrigerator', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SLOW_COOKER: { name: 'slow cooker', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        STAND_MIXER: { name: 'stand mixer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        STOVE: { name: 'stove', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        TOASTER: { name: 'toaster', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        TOASTER_OVEN: { name: 'toaster oven', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        WAFFLE_MAKER: { name: 'waffle maker', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
    },
    BABY: {},
    BAKING: {
        ALL_PURPOSE_FLOUR: {
        ...
        GRAHAM_CRACKER_PIE_CRUST: { name: 'graham cracker pie crust', category: INGREDIENT_CATEGORY.BAKING },
    ...
    COOKING_SUPPLIES: {
        ...
        BAGUETTE_PAN: { name: 'baguette pan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        BAMBOO_SKEWERS: { name: 'bamboo skewers', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        BASTER: { name: 'baster', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        CLEAVER: { name: 'cleaver', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        COOKING_THERMOMETER: { name: 'cooking thermometer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        COOLING_RACK: { name: 'cooling rack', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        COOKIE_CUTTERS: { name: 'cookie cutters', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        CUPCAKE_LINER: { name: 'cupcake liner', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        FORK: { name: 'fork', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        LADLE: { name: 'ladle', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        MEAT_MALLET: { name: 'meat mallet', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        MEDIUM_BOWL: { name: 'medium bowl', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        PEELER: { name: 'peeler', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        PIE_PAN: { name: 'pie pan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        PIPING_BAG: { name: 'piping bag', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        PLATE: { name: 'plate', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        RAMEKIN: { name: 'ramekin', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        RICE_COOKER: { name: 'rice cooker', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ROASTING_PAN: { name: 'roasting pan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ROLLING_PIN: { name: 'rolling pin', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        RUBBER_SPATULA: { name: 'rubber spatula', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SAUCEPAN: { name: 'saucepan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SCORING_KNIFE: { name: 'scoring knife', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        ...
        SMALL_PAN: { name: 'small pan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SPATULA: { name: 'spatula', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SPIDER_STRAINER: { name: 'spider strainer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SPOON: { name: 'spoon', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        SPRINGFORM_PAN: { name: 'springform pan', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
        STEAMER: { name: 'steamer', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
    ...
    OILS: {
        ...
        WHITE_TRUFFLE_OIL: { name: 'white truffle oil', category: INGREDIENT_CATEGORY.OILS },

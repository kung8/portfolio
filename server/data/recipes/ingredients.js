...
const INGREDIENTS = {
    ...
    CEREAL: {
        APPLE_JACKS_CEREAL: { name: 'apple jacks cereal', category: INGREDIENT_CATEGORY.CEREAL },
        BELVITA_BREAKFAST_BISCUITS: { name: 'belvita breakfast biscuits', category: INGREDIENT_CATEGORY.CEREAL },
        CAPTAIN_CRUNCH_CEREAL: { name: 'captain crunch cereal', category: INGREDIENT_CATEGORY.CEREAL },
        CHEX_CEREAL: { name: 'chex cereal', category: INGREDIENT_CATEGORY.CEREAL },
        CHERRIOS_CEREAL: { name: 'cherrios cereal', category: INGREDIENT_CATEGORY.CEREAL },
        CINNAMON_TOAST_CRUNCH_CEREAL: { name: 'cinnamon toast crunch cereal', category: INGREDIENT_CATEGORY.CEREAL },
        COCOA_PEBBLES_CEREAL: { name: 'cocoa pebbles cereal', category: INGREDIENT_CATEGORY.CEREAL },
        COOKIE_CRISP_CEREAL: { name: 'cookie crisp cereal', category: INGREDIENT_CATEGORY.CEREAL },
        CORN_FLAKES_CEREAL: { name: 'corn flakes cereal', category: INGREDIENT_CATEGORY.CEREAL },
        FROSTED_FLAKES_CEREAL: { name: 'frosted flakes cereal', category: INGREDIENT_CATEGORY.CEREAL },
        FROSTED_WHEATS_CEREAL: { name: 'frosted wheats cereal', category: INGREDIENT_CATEGORY.CEREAL },
        FRUIT_LOOPS_CEREAL: { name: 'fruit loops cereal', category: INGREDIENT_CATEGORY.CEREAL },
        FRUITY_PEBBLES_CEREAL: { name: 'fruity pebbles cereal', category: INGREDIENT_CATEGORY.CEREAL },
        GRANOLA: { name: 'granola', category: INGREDIENT_CATEGORY.CEREAL },
        GRITS: { name: 'grits', category: INGREDIENT_CATEGORY.CEREAL },
        HONEY_BUNCHES_OF_OATS_CEREAL: { name: 'honey bunches of oats cereal', category: INGREDIENT_CATEGORY.CEREAL },
        HONEY_COMBS_CEREAL: { name: 'honey combs cereal', category: INGREDIENT_CATEGORY.CEREAL },
        HONEY_NUT_CHEERIOS_CEREAL: { name: 'honey nut cheerios cereal', category: INGREDIENT_CATEGORY.CEREAL },
        KRAVE_CEREAL: { name: 'krave cereal', category: INGREDIENT_CATEGORY.CEREAL },
        LIFE_CEREAL: { name: 'life cereal', category: INGREDIENT_CATEGORY.CEREAL },
        LUCKY_CHARMS_CEREAL: { name: 'lucky charms cereal', category: INGREDIENT_CATEGORY.CEREAL },
        MUESLI: { name: 'muesli', category: INGREDIENT_CATEGORY.CEREAL },
        MUFFIN_TOPS_CEREAL: { name: 'muffin tops cereal', category: INGREDIENT_CATEGORY.CEREAL },
        PANCAKE_MIX: { name: 'pancake mix', category: INGREDIENT_CATEGORY.CEREAL },
        POP_TARTS: { name: 'pop tarts', category: INGREDIENT_CATEGORY.CEREAL },        
        POPS_CEREAL: { name: 'pops cereal', category: INGREDIENT_CATEGORY.CEREAL },
        REESES_PUFFS_CEREAL: { name: 'reeses puffs cereal', category: INGREDIENT_CATEGORY.CEREAL },
        RICE_KRISPIES_CEREAL: { name: 'rice krispies cereal', category: INGREDIENT_CATEGORY.CEREAL },
        SHREDDED_WHEAT_CEREAL: { name: 'shredded wheat cereal', category: INGREDIENT_CATEGORY.CEREAL },
        SPECIAL_K_CEREAL: { name: 'special k cereal', category: INGREDIENT_CATEGORY.CEREAL },
        STEEL_OATS: { name: 'steel oats', category: INGREDIENT_CATEGORY.CEREAL },
        TOASTER_STRUDEL: { name: 'toaster strudel', category: INGREDIENT_CATEGORY.CEREAL },
        TRIX_CEREAL: { name: 'trix cereal', category: INGREDIENT_CATEGORY.CEREAL },
    },
    CONDIMENTS: {
    ...
    COOKING_SUPPLIES: {
        ...
        CROCKPOT: { name: 'crockpot', category: INGREDIENT_CATEGORY.COOKING_SUPPLIES },
    ...
    PRODUCE: {
        ...
        BARLETT_PEARS: { name: 'barlett pears', category: INGREDIENT_CATEGORY.PRODUCE },
        ...
        BRUSSEL_SPROUTS: { name: 'brussel sprouts', category: INGREDIENT_CATEGORY.PRODUCE },
        ...
        CHINESE_MUSTARS_GREENS: { name: 'Chinese mustard greens', category: INGREDIENT_CATEGORY.PRODUCE },
        ...
        HONEY_CRISP_APPLES: { name: 'honeycrisp apples', category: INGREDIENT_CATEGORY.PRODUCE },
        ...
        RADDISH: { name: 'raddish', category: INGREDIENT_CATEGORY.PRODUCE },
    ...
    SEAFOOD: {
        ...
        MUSSSELS: { name: 'mussels', category: INGREDIENT_CATEGORY.SEAFOOD },
    ...
    SNACKS: {
        ...
        GRANOLA_BARS: { name: 'granola bars', category: INGREDIENT_CATEGORY.CEREAL },

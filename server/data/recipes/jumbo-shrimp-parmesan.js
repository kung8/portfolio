...
module.exports = {
    ...
    allergies: [ALLERGIES.DAIRY, ALLERGIES.GLUTEN, ALLERGIES.SHELLFISH, ALLERGIES.WHEAT],
    ...
    directions: [
        ...
        { step: `Bake until the shrimp is cooked (about 10 minutes).`, section: SECTIONS.BAKE },

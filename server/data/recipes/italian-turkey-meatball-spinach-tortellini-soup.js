...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'breadcrumbs', amount: '2 T', additionalDetails: '', optional: false },
        { name: 'parmesan cheese', amount: '2 T', additionalDetails: '', optional: false },
        { name: 'parsley', amount: '2 T', additionalDetails: '', optional: false },
        ...
        { name: 'salt', amount: '1/8 t', additionalDetails: '', optional: false },
        { name: 'unsalted butter', amount: '1/2 T', additionalDetails: '', optional: false },
    ...
    directions: [
        ...
        { step: 'Make small meatballs (about 1 T each).', type: SECTIONS.MAIN },

...
module.exports = {
    ...
    ingredients: [
        ...
        { ...CELERY, amount: '2 stalks', additionalDetails: 'chopped', optional: false, section: SECTIONS.MAIN },
        { ...MEDIUM_YELLOW_ONION, amount: '1 small', additionalDetails: 'chopped', optional: false, section: SECTIONS.MAIN },
        { ...CARROTS, amount: '1 large', additionalDetails: 'peeled and chopped', optional: false, section: SECTIONS.MAIN },
        { ...GARLIC, amount: '2 clove', additionalDetails: 'minced', optional: false, section: SECTIONS.MAIN },

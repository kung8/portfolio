...
module.exports = {
    ...
    directions: [
        { step: 'Cut the chicken into 1-inch pieces and place in a ziploc bag.', section: SECTIONS.MARINADE },
        { step: 'Combine the marinade ingredients in a blender. Add some water as needed.', section: SECTIONS.MARINADE },
        { step: 'Add the marinade ingredients into the ziploc bag.', section: SECTIONS.MARINADE },
        { step: 'Marinate for at least 6 hours in the fridge, or overnight.', section: SECTIONS.MARINADE },
        { step: 'Preheat the oven to 450°F.', section: SECTIONS.MAIN },
        { step: 'Thread 5 to 6 chicken pieces on the skewer, leaving gaps between chicken.', section: SECTIONS.MAIN },
        { step: 'Bake for 15 to 25 minutes (cooking time will vary depending on the size of meat).', section: SECTIONS.MAIN },
        { step: 'Serve with cucumbers.', section: SECTIONS.SERVE },
    ],
    notes: [

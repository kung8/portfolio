...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2025-05-26 01:01:02',
    modifiedAt: '2026-06-04 19:42:54',
    ...
    directions: [
        ...
        { step: `Place a 1/4 cup of the filling 1 inch from the corner nearest you.`, section: PREP_SPRING_ROLLS, img: rolls1 },
        { step: `Carefully roll the spring roll wrapper until it reaches the middle.`, section: PREP_SPRING_ROLLS, img: rolls2 },
        { step: `Fold over the sides.`, section: PREP_SPRING_ROLLS, img: rolls3 },
        ...
        { step: `Press to seal.`, section: PREP_SPRING_ROLLS, img: rolls4 },
        ...
        { step: `Deep fry pizza egg rolls until golden brown (about 1 to 2 minutes each side).`, section: SECTIONS.DEEP_FRY, img: rolls5 },
        { step: `Place on cooling rack to drain.`, section: SECTIONS.DEEP_FRY, img: rolls6 },

...
const chicken2 = '../assets/Products/garlic-chicken-with-herbs-cooking-chicken-2.jpeg';
const chicken3 = '../assets/Products/garlic-chicken-with-herbs-cooking-chicken-3.jpeg';
const zoomed = '../assets/Products/garlic-chicken-with-herbs-cooking-chicken-zoomed.jpeg';
const covered1 = '../assets/Products/garlic-chicken-with-herbs-covered-1.jpeg';
...
const fragrant = '../assets/Products/garlic-chicken-with-herbs-fragrant.jpeg';
...
const stock = '../assets/Products/garlic-chicken-with-herbs-stock.jpeg';
...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Add chicken and brown on both sides.', type: SECTIONS.CHICKEN, img: [chicken1, chicken2, chicken3, flipped] },
        ...
        { step: 'Add wine and herbs. Bring to a boil and stir.', type: SECTIONS.MAIN, img: [wine, fragrant, sauteed] },
        { step: 'Cook until wine is almost evaporated.', type: SECTIONS.MAIN },
        { step: 'Add chicken broth and chicken. Bring to a boil.', type: SECTIONS.MAIN, img: [stock, cooked2] },
        { step: 'Reduce heat to low. Cover and simmer (about 10 to 12 minutes).', type: SECTIONS.MAIN, img: [covered1, covered2] },

...
const { AIR_FRYER, BLACK_PEPPER, CHEDDAR_CHEESE, COOKING_SPRAY, CUTTING_BOARD, DIJON_MUSTARD, FISH_SAUCE, GARLIC, GREEK_YOGURT, GROUND_BEEF, KETCHUP, MEDIUM_BOWL, MIXING_BOWL, OLIVE_OIL, PICKLES, PICKLE_JUICE, RED_ONION, SALT, SMOKED_PAPRIKA, SPRING_ROLL_RICE_WRAPPERS, SPRING_ROLL_WRAPPER } = require('./ingredients');
...
module.exports = {
    ...
    allergies: [ALLERGIES.DAIRY, ALLERGIES.FISH],

...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'salt', amount: '2 t', additionalDetails: '', optional: false, section: SECTIONS.DOUGH },
        { name: 'instant dry yeast', amount: '1 t', additionalDetails: '', optional: false, section: SECTIONS.DOUGH },
        { name: 'honey', amount: '1 T', additionalDetails: '', optional: false, section: SECTIONS.DOUGH },
        { name: 'water', amount: '2 c', additionalDetails: 'room-temperature', optional: false, section: SECTIONS.DOUGH },
        { name: 'olive oil', amount: '2 T', additionalDetails: '', optional: false, section: SECTIONS.DOUGH },
        { name: 'garlic', amount: '3 cloves', additionalDetails: 'minced', optional: false, section: SECTIONS.MAIN },
        { name: 'butter', amount: '3 T', additionalDetails: 'melted', optional: false, section: SECTIONS.MAIN },
        { name: 'parsley', amount: '3 t', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
    ...
    directions: [
        ...
        { step: 'When you are ready to make the garlic bread, preheat the oven too 450ºF.', type: SECTIONS.DOUGH },
        ...
        { step: 'Brush the dough with a generous amount of melted butter and sprinkle with minced garlic and parsley.', type: SECTIONS.MAIN },
        { step: 'Place the breadsticks on the baking sheet.', type: SECTIONS.MAIN },
        { step: 'Bake the breadsticks for 20 to 25 minutes or until a nice golden brown.', type: SECTIONS.MAIN },

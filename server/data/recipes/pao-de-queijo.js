...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-07-06 01:28:45',
    modifiedAt: '2026-06-04 18:51:30',
    ...
    directions: [
        ...
        { step: `In a stand mixer bowl, combine tapioca flour.`, section: SECTIONS.PREP_DOUGH },
        { step: `Over medium-high heat, combine milk, water, oil and salt in a saucepan.`, section: SECTIONS.PREP_DOUGH },
        { step: `Bring to a boil.`, section: SECTIONS.PREP_DOUGH },
        { step: `Pour the boiled milk into the stand mixer bowl.`, section: SECTIONS.PREP_DOUGH, img: cheeseball1 },
        ...
        { step: `Slowly add the cheeses until it is well mixed.`, section: SECTIONS.PREP_DOUGH },
        { step: `The dough will most likely be sticky, so I added about another cup of tapioca starch to thicken the batter. Slowly add the cornstarch.`, section: SECTIONS.PREP_DOUGH },
        { step: `Shape the dough into 1.5 inch balls.`, section: SECTIONS.PREP_DOUGH, img: cheeseball2 },
        { step: `Place on a baking sheet about 2 inches apart. They do not expand very much.`, section: SECTIONS.PREP_DOUGH },

        { step: `Bake until the cheeseballs are a golden brown (about 15 to 25 minutes).`, section: SECTIONS.BAKE },

        { step: `Serve these warm.`, section: SECTIONS.SERVE },
    ],
    store: [
        {

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...WHITE_SUGAR, amount: '1 c', additionalDetails: '', section: DRY_SECTION },
        { ...ALL_PURPOSE_FLOUR, amount: '3/4 c', additionalDetails: '', section: DRY_SECTION },
        { ...COCOA_POWDER, amount: '2/3 c', additionalDetails: '', section: DRY_SECTION },
        { ...POWDERED_SUGAR, amount: '1/2 c', additionalDetails: '', section: DRY_SECTION },
        { ...SEMI_SWEET_CHOCOLATE_CHIPS, amount: '1/2 c', additionalDetails: '', section: DRY_SECTION },
        { ...SEA_SALT, amount: '3/4 tsp', additionalDetails: '', section: DRY_SECTION },

        { ...EGGS, amount: '2', additionalDetails: '', section: WET_SECTION },
        { ...CANOLA_OIL, amount: '1/2 c', additionalDetails: '', section: WET_SECTION },
        { ...WARM_WATER, amount: '2 Tbsp', additionalDetails: '', section: WET_SECTION },
        { ...VANILLA_EXTRACT, amount: '1/2 tsp', additionalDetails: '', section: WET_SECTION },
    ],
    appliances: [
        { name: 'oven' },
    ],

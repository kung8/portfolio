...
module.exports = {
    ...
    ingredients: [
        { ...SKIRT_STEAK, amount: '4 8-oz', unit: '', additionalDetails: 'strips', section: SECTIONS.MEAT },
        { ...BALSAMIC_VINEGAR, amount: '1/3 c', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...LIGHT_SOY_SAUCE, amount: '1/3 c', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...VEGETABLE_OIL, amount: '1/4 c', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...WORCESTERSHIRE_SAUCE, amount: '2 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...HONEY, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...ITALIAN_SEASONING, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...GARLIC_POWDER, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...GROUND_MUSTARD, amount: '1 tsp', unit: '', additionalDetails: '', section: SECTIONS.MEAT },
        { ...PARSLEY, amount: '', unit: '', additionalDetails: 'to garnish', section: SECTIONS.MEAT },

        { ...RANCH_DIP_DRESSING, amount: '1 packet', unit: '', additionalDetails: '', section: CILANTRO_RANCH_DRESSING },
        { ...MAYONNAISE, amount: '1 c', unit: '', additionalDetails: '', section: CILANTRO_RANCH_DRESSING },
        { ...SOUR_CREAM, amount: '1 c', unit: '', additionalDetails: '', section: CILANTRO_RANCH_DRESSING },
        { ...CILANTRO, amount: '1 bunch', unit: '', additionalDetails: '', section: CILANTRO_RANCH_DRESSING },
        { ...GARLIC, amount: '1 clove', unit: '', additionalDetails: 'minced', section: CILANTRO_RANCH_DRESSING },
        { ...JALAPENO_PEPPERS, amount: '1 - 3', unit: '', additionalDetails: 'depending on spice tolerance', section: CILANTRO_RANCH_DRESSING },
        { ...MILK, amount: '1/3 - 1/2 c', unit: '', additionalDetails: 'depending on preferred thickness', section: CILANTRO_RANCH_DRESSING },

        { ...TORTILLA, amount: '8', unit: '', additionalDetails: '', section: SECTIONS.MAIN },
        { ...CHIPOTLE_SALAD_KITS, amount: '32 oz', unit: '', additionalDetails: '', section: SECTIONS.MAIN },
        { ...BROWN_RICE, amount: '2 c', unit: '', additionalDetails: 'cooked', section: SECTIONS.MAIN },
        { ...CHEDDAR_CHEESE, amount: '8 oz', unit: '', additionalDetails: 'shredded', section: SECTIONS.MAIN },
        { ...BLACK_BEANS, amount: '15 oz can of', unit: '', additionalDetails: 'drained', section: SECTIONS.MAIN },
        { ...SOUR_CREAM, amount: '8 oz', unit: '', additionalDetails: '', section: SECTIONS.MAIN },

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '1.5 lb', additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...SALT, amount: '2 tsp', additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...WHITE_SUGAR, amount: '1 tsp', additionalDetails: '', section: SECTIONS.CHICKEN },

        { ...ROOM_TEMPERATURE_WATER, amount: '1 c', additionalDetails: '', section: WET_BATTER_STATION },
        { ...CORNSTARCH, amount: '1/4 c', additionalDetails: '', section: WET_BATTER_STATION },
        
        { ...ALL_PURPOSE_FLOUR, amount: '3 c', additionalDetails: '', section: FLOUR_DREDGING_STATION },
        { ...SALT, amount: '1 Tbsp', additionalDetails: '', section: FLOUR_DREDGING_STATION },
        { ...WHITE_PEPPER, amount: '1 tsp', additionalDetails: '', section: FLOUR_DREDGING_STATION },
        { ...CELERY_POWDER, amount: '1 tsp', additionalDetails: '', section: FLOUR_DREDGING_STATION },

        { ...CORNSTARCH, amount: '1/2 c', additionalDetails: '', section: TEMPURA_BATTER_STATION },
        { ...ALL_PURPOSE_FLOUR, amount: '3/4 c', additionalDetails: '', section: TEMPURA_BATTER_STATION },
        { ...BAKING_POWDER, amount: '1 1/4 tsp', additionalDetails: '', section: TEMPURA_BATTER_STATION },
        { ...BAKING_SODA, amount: '1/4 tsp', additionalDetails: '', section: TEMPURA_BATTER_STATION },
        { ...EGGS, amount: '2', additionalDetails: '', section: TEMPURA_BATTER_STATION },
        { ...COLD_WATER, amount: '1 c', additionalDetails: '', section: TEMPURA_BATTER_STATION },

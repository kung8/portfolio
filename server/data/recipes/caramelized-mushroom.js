...
module.exports = {
    ...
    cookTime: '20 m',
    ingredients: [
        { name: 'mushroom', amount: '8 oz', additionalDetails: '', optional: false, section: TOPPING },
    ...
    directions: [
        ...
        { step: 'Add the mushroom and let it brown.', type: TOPPING },
        { step: 'Add the brown sugar, balsamic vinegar, and soy sauce when the mushroom begins to brown.', type: TOPPING },
        { step: 'Stir and cook for about 3 minutes.', type: TOPPING },
        { step: 'Season with salt and pepper and cook until mushrooms are browned and soft.', type: TOPPING },

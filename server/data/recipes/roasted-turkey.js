...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'thyme', amount: '1 t + more as desired', additionalDetails: '', optional: false },
        { name: 'rosemary', amount: '1 t + more as desired', additionalDetails: '', optional: false },
    ...
    directions: [
        ...
        { step: 'Stuff garlic halves, lemon slices, and the additional amount of rosemary and thyme into the cavity of the turkey (note reserve at least the 1 t of each for the rub)', type: SECTIONS.MAIN },

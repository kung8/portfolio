...
module.exports = {
    ...
    directions: [
        { step: 'Note: Typically you need to cook a turkey for about 13 - 15 min per pound. Small = 13 lb or less; large = 14 lb or more. Refer to additional resources to plan for thawing and cooking estimates (figures 1 and 2, respectively).', type: MAIN, img: turkeyThawingTable },
        ...
        { step: 'Roast uncovered for 30 min for small turkey or 45 min for large turkey.', type: MAIN, img: turkeyCookingTable},

...
module.exports = {
    ...
    separated: false,
    ingredients: [
        { name: 'chicken thigh', amount: '5 pounds', additionalDetails: 'sliced', optional: false, section: '' },
        { name: 'red curry paste', amount: '1/4 c', additionalDetails: '', optional: false, section: '' },
        { name: 'coconut milk', amount: '13.5 oz', additionalDetails: '', optional: false, section: '' },
        { name: 'lemongrass', amount: '', additionalDetails: 'diagonally sliced', optional: false, section: '' },
        { name: 'kaffir lime leaves', amount: '10 - 12', additionalDetails: '', optional: false, section: '' },
        { name: 'water', amount: '', additionalDetails: 'to thin', optional: false, section: '' },

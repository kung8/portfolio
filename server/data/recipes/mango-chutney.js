...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...VEGETABLE_OIL, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: VEGGIES_SECTION },
        { ...GINGER, amount: 2, unit: UNITS.TEASPOON, additionalDetails: '', section: VEGGIES_SECTION },
        { ...GARLIC, amount: 2, unit: UNITS.CLOVE, additionalDetails: '', section: VEGGIES_SECTION },
        { ...RED_CHILI, amount: 1, unit: '', additionalDetails: '', section: VEGGIES_SECTION },
        { ...NIGELLA_SEED, amount: 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...CORIANDER, amount: 1, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...CUMIN, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...TURMERIC, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...CARDAMOM, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...CLOVES, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...CINNAMON, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: SPICES_SECTION },
        { ...SALT, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: MANGO_SECTION },
        { ...MANGOES, amount: 5, unit: '', additionalDetails: 'peeled and diced', section: MANGO_SECTION },
        { ...WHITE_SUGAR, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: MANGO_SECTION },
        { ...WHITE_VINEGAR, amount: 1, unit: UNITS.CUP, additionalDetails: '', section: MANGO_SECTION },
    ],
    appliances: [
        { name: 'stove' },
    ],

...
module.exports = {
    ...
    available: true,
    recommended: false,
    createdAt: '2024-12-14 10:51:01',
    modifiedAt: '2026-06-02 21:32:51',
    ...
    directions: [
        { step: `Prep the vegetables, chicken and aromatics.`, section: PREP_VEGGIES },
        { step: `Season the sliced chicken with black pepper.`, section: PREP_CHICKEN },
        { step: `Over medium heat, add vegetable oil to a large pot.`, section: COOK_CURRY },
        { step: `Add onions. Saute and stir occasionally until translucent, golden and tender (about 5 minutes). Caramelizing the onions adds flavor.`, section: COOK_CURRY },
        { step: `Add garlic and ginger. Mix.`, section: COOK_CURRY },
        { step: `Add chicken. Cook and stir often until no longer pink. Reduce heat to medium-low temporarily if the onions are too brown.`, section: COOK_CURRY },
        { step: `Add chicken broth.`, section: COOK_CURRY },
        { step: `Add apple, honey, soy sauce and ketchup. Mix.`, section: COOK_CURRY },
        { step: `Add carrots and potatoes.`, section: COOK_CURRY },
        ...
        { step: `Reduce heat to medium-low heat and cover with a lid. Let it simmer for 15 minutes.`, section: COOK_CURRY },
        ...
        { step: `In a ladle of broth, add 1 to 2 cubes of the Japanese curry mix. Stir within the ladle to help it dissolve then mix it into the pot.`, section: COOK_CURRY, img: [curry1, curry2] },
        ...
        { step: `Over medium-low heat, simmer uncovered while stirring often until the curry becomes thick (about 5 to 10 minutes). Thin curry out with water if needed. When stirring, be sure to scrape the bottom to prevent burning.`, section: COOK_CURRY },
        { step: `Enjoy this curry over Japanese rice.`, section: SECTIONS.SERVE },
    ],
    store: [
        {

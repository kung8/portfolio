...
const { ALUMINUM_FOIL, BAKING_SHEET, BASTER, BLACK_PEPPER, BONELESS_AND_SKINLESS_CHICKEN_THIGH, CHILI_POWDER, COOLING_RACK, CORIANDER, CORIANDER_POWDER, FENUGREEK_LEAVES, GARAM_MASALA, GINGER_GARLIC_PASTE, GREEK_YOGURT, KNIFE, LEMON_JUICE, MIXING_BOWL, MUSTARD_OIL, OVEN, PAPER_TOWELS, REFRIGERATOR, SALT, SMALL_BOWL, TURMERIC } = require('./ingredients');

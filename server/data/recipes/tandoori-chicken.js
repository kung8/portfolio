...
module.exports = {
    ...
    ingredients: [
        ...
        { ...GREEK_YOGURT, amount: 1 / 2, unit: INGREDIENT_UNITS.CUP, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...GINGER_GARLIC_PASTE, amount: 1, unit: INGREDIENT_UNITS.TABLESPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...GARAM_MASALA, amount: 1, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...CHILI_POWDER, amount: 1, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...SALT, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...TURMERIC, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...FENUGREEK_LEAVES, amount: 1, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...BLACK_PEPPER, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...CORIANDER_POWDER, amount: 1, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...MUSTARD_OIL, amount: 3 / 2, unit: INGREDIENT_UNITS.TABLESPOON, additionalDetails: '', section: CHICKEN_MARINADE },
        { ...LEMON_JUICE, amount: 1, unit: INGREDIENT_UNITS.TABLESPOON, additionalDetails: '', section: CHICKEN_MARINADE },
    ...
    directions: [
        { step: 'In a mixing bowl, combine the "Chicken Marinade" ingredients.', section: PREP_CHICKEN, img: tandoori1 },
        { step: 'Taste and adjust based on your spice tolerance.', section: PREP_CHICKEN },
        { step: 'Pat chicken with paper towels until dry.', section: PREP_CHICKEN },
        { step: 'Use a knife to make deep 3 slits (4 slits for larger pieces).', section: PREP_CHICKEN, img: tandoori2 },
        { step: 'Coat the chicken with the marinade. Cover and refrigerate for at least 6 hours or overnight. ', section: PREP_CHICKEN, img: tandoori3 },

        { step: 'In a small bowl, combine the "Red Chili Oil" ingredients. Set aside.', section: PREP_RED_CHILI_OIL },

        { step: 'Preheat the oven to 470ºF.', section: COOK_CHICKEN },
        { step: 'Line a baking sheet with foil and place a wire rack on top.', section: COOK_CHICKEN, img: tandoori4 },
        { step: 'Spray the wire rack with oil.', section: COOK_CHICKEN },
        { step: 'Place the chicken on the rack.', section: COOK_CHICKEN, img: tandoori5 },
        { step: 'Roast the chicken for 12 to 15 minutes.', section: COOK_CHICKEN },
        { step: 'Baste the chicken with the red chili oil and flip the chicken over.', section: COOK_CHICKEN, img: tandoori6 },
        { step: 'Roast for another 12 to 15 minutes.', section: COOK_CHICKEN },
        { step: 'Broil the chicken for 2 to 3 minutes. To char the chicken a little.', section: COOK_CHICKEN, img: tandoori7 },
        { step: 'Check the internal temperature of the chicken is at least 165ºF.', section: COOK_CHICKEN },
        { step: 'Brush the chicken with its drippings.', section: COOK_CHICKEN },

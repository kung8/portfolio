...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...OLIVE_OIL, amount: '1 Tbsp', additionalDetails: '', section: MEAT_SECTION },
        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '2', additionalDetails: 'bite sized', section: MEAT_SECTION },
        { ...ANDOUILLE_SAUSAGE, amount: '1 lb', additionalDetails: 'thinly sliced', section: MEAT_SECTION },

        { ...OLIVE_OIL, amount: '2 Tbsp', additionalDetails: '', section: VEGGIES_SECTION },
        { ...YELLOW_BELL_PEPPERS, amount: '1', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...RED_BELL_PEPPERS, amount: '1', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...GREEN_BELL_PEPPERS, amount: '1', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...CELERY, amount: '2 ribs', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...JALAPENO_PEPPERS, amount: '1 - 2', additionalDetails: 'chopped', section: VEGGIES_SECTION },
        { ...WHITE_ONION, amount: '1', additionalDetails: 'diced', section: VEGGIES_SECTION },
        { ...GARLIC, amount: '4 cloves', additionalDetails: 'minced', section: VEGGIES_SECTION },

        { ...CRUSHED_TOMATOES, amount: '14 oz', additionalDetails: '', section: RICE_SECTION },
        { ...CHICKEN_BROTH, amount: '3 - 4 c', additionalDetails: '', section: RICE_SECTION },
        { ...WHITE_RICE, amount: '1 1/2 c', additionalDetails: '', section: RICE_SECTION },
        { ...CAJUN_SEASONING, amount: '2 Tbsp', additionalDetails: '', section: RICE_SECTION },
        { ...THYME, amount: '1 tsp', additionalDetails: '', section: RICE_SECTION },
        { ...CAYENNE_PEPPER, amount: '1/4 tsp', additionalDetails: '', section: RICE_SECTION },
        { ...BAY_LEAVES, amount: '1', additionalDetails: '', section: RICE_SECTION },

        { ...LARGE_SHRIMP, amount: '1 lb', additionalDetails: 'peeled and deveined', section: SHRIMP_SECTION },
        { ...OKRA, amount: '1 c', additionalDetails: 'thinly sliced', section: SHRIMP_SECTION },
        { ...SALT, amount: '2 tsp', additionalDetails: '', section: SHRIMP_SECTION },
        { ...BLACK_PEPPER, amount: '1/2 tsp', additionalDetails: '', section: SHRIMP_SECTION },

        { ...PARSLEY, amount: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...GREEN_ONIONS, amount: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...HOT_SAUCE, amount: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

...
module.exports = {
    ...
    directions: [
        { step: 'Over medium-high heat, heat oil in a large pot.', section: COOK_MEAT },
        { step: 'Add chicken and sausage. Saute until the chicken is cooked through and sausage is browned (about 5 to 7 minutes).', section: COOK_MEAT },
        { step: 'Transfer meats to a plate and set aside.', section: COOK_MEAT },

        { step: 'Over medium-high heat, add oil to the large pot.', section: COOK_VEGGIES },
        { step: 'Add the rest of the "Veggies" section ingredients. If you prefer a mild spice level, leave out the jalapeno peppers.', section: COOK_VEGGIES },
        { step: 'Saute until the onions are softened (about 6 minutes).', section: COOK_VEGGIES },

        { step: 'Add crushed tomatoes, broth, rice, Cajun seasoning, thyme, cayenne pepper, and bay leaf to the large pot. Stir.', section: COOK_RICE },
        { step: 'Cook until it simmers.', section: COOK_RICE },
        { step: 'Reduce to medium-low heat.', section: COOK_RICE },
        { step: 'Cover and simmer until the rice is almost cooked through (about 25 to 30 minutes). Stir every 5 minutes to prevent the rice burning.', section: COOK_RICE },

        { step: 'Add shrimp and okra. Stir.', section: COOK_SHRIMP },
        { step: 'Simmer and stir occasionally. Cook until shrimp is cooked through and pink.', section: COOK_SHRIMP },
        { step: 'Remove the bay leaf and re-add the chicken and sausage.', section: COOK_SHRIMP },
        { step: 'Taste and add salt, pepper and Cajun seasoning as needed.', section: COOK_SHRIMP },

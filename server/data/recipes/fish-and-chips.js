...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Season with salt and pepper.', type: PREP_FISH },
        { step: 'Line a baking sheet with paper towels and place a wire rack on top.', type: PREP_FISH },
        { step: 'In a mixing bowl, combine the "Beer Batter" section ingredients until it is smooth.', type: PREP_FISH },
        { step: 'Dip the fish into the beer batter, one at a time, then immediately into the hot oil. Be carefully to not crowd the oil.', type: PREP_FISH },
        { step: 'Deep fry the fish until they are golden brown (about 3 to 4 minutes).', type: DEEP_FRY },
        { step: 'Transfer the fish to the wire rack to drip.', type: DEEP_FRY },

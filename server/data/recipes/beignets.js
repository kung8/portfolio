...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...WARM_WATER, amount: '1 1/2 c', additionalDetails: '', section: YEAST_MIXTURE_SECTION },
        { ...WHITE_SUGAR, amount: '2/3 c', additionalDetails: '', section: YEAST_MIXTURE_SECTION },
        { ...YEAST, amount: '2 1/4 tsp', additionalDetails: '', section: YEAST_MIXTURE_SECTION },
        { ...EGGS, amount: '2', additionalDetails: 'room temperature', section: DOUGH_SECTION },
        { ...EVAPORATED_MILK, amount: '1 c', additionalDetails: '', section: DOUGH_SECTION },
        { ...VANILLA_EXTRACT, amount: '2 1/2 tsp', additionalDetails: '', section: DOUGH_SECTION },
        { ...BREAD_FLOUR, amount: '7 c', additionalDetails: '', section: DOUGH_SECTION },
        { ...SALT, amount: '1 1/2 tsp', additionalDetails: '', section: DOUGH_SECTION },
        { ...UNSALTED_BUTTER, amount: '5 Tbsp', additionalDetails: 'room temperature', section: DOUGH_SECTION },
        { ...PEANUT_OIL, amount: '4 c', additionalDetails: '', section: DEEP_FRY },
        { ...POWDERED_SUGAR, amount: '2 c', additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
        { name: 'stand mixer' },

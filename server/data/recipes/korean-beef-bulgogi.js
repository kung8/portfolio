...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'sesame oil', amount: '4 T', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'soy sauce', amount: '1/2 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'brown sugar', amount: '4 T', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'garlic', amount: '6 cloves', additionalDetails: 'minced', optional: false, section: SECTIONS.MAIN },
        { name: 'ginger', amount: '2 T', additionalDetails: 'peeled and diced', optional: false, section: SECTIONS.MAIN },
        { name: 'gochujang', amount: '2 T', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'vegetable oil', amount: '2 T', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'sesame seeds', amount: '2 t', additionalDetails: '', optional: false, section: SECTIONS.TOPPINGS },
    ],
    supplies: [
        { name: 'ziploc' },
        { name: 'peeler' },
    ...
    directions: [
        ...
        { step: 'Heat frying pan over medium heat and add 1 T vegetable and cook beef in batches.', type: SECTIONS.MAIN },

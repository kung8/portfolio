...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'beef', amount: '3 lbs', additionalDetails: 'cubed', section: BEEF },
        { name: 'pear', amount: '1', additionalDetails: 'finely diced', section: BEEF },
        { name: 'sesame oil', amount: '4 Tbsp', additionalDetails: '', section: BEEF },
        { name: 'soy sauce', amount: '1/2 c', additionalDetails: '', section: BEEF },
        { name: 'brown sugar', amount: '4 Tbsp', additionalDetails: '', section: BEEF },
        { name: 'garlic', amount: '6 cloves', additionalDetails: 'minced', section: BEEF },
        { name: 'ginger', amount: '2 Tbsp', additionalDetails: 'peeled and diced', section: BEEF },
        { name: 'gochujang', amount: '2 Tbsp', additionalDetails: '', section: BEEF },
        { name: 'vegetable oil', amount: '2 Tbsp', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'rice', amount: '', additionalDetails: '', section: SECTIONS.SERVE },
        { name: 'green onion', amount: '4', additionalDetails: 'sliced', section: SECTIONS.SERVE },
        { name: 'sesame seeds', amount: '2 tsp', additionalDetails: '', section: SECTIONS.SERVE },
    ],
    appliances: [
        { name: 'stove' },
    ],

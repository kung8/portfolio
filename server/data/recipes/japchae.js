...
module.exports = {
    ...
    directions: [
        { step: 'Boil water in a pot and cook glass noodles as instructed from the packaging.', section: COOK_NOODLES, img: japchae1 },
        { step: 'Drain and rinse in cold water.', section: COOK_NOODLES, img: japchae2 },
        { step: 'Cut the noodles a few times with cooking scissors.', section: COOK_NOODLES },

        { step: 'In a small bowl, whisk eggs.', section: COOK_EGGS },
        { step: 'Over medium heat, heat oil in a frying pan.', section: COOK_EGGS },
        { step: 'Add whisked eggs into pan. Tilt the pan in a circular motion to spread the egg.', section: COOK_EGGS },
        { step: 'Cook the egg for a minute.', section: COOK_EGGS },
        { step: 'Flip and cook for another minute.', section: COOK_EGGS, img: japchae3 },
        { step: 'Transfer to a cutting board to cool.', section: COOK_EGGS },
        { step: 'Cut eggs into thin strips.', section: COOK_EGGS, img: japchae4 },

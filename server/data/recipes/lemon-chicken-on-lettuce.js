...
module.exports = {
    ...
    cookTime: '15 m',
    ingredients: [
        { name: 'vegetable oil', amount: '1 Tbsp', additionalDetails: '', optional: false, section: '' },
        { name: 'chicken', amount: '1.5 lb', additionalDetails: 'sliced', optional: false, section: '' },
        { name: 'lemon juice', amount: '2 Tbsp', additionalDetails: '', optional: false, section: '' },
        { name: 'soy sauce', amount: '1 Tbsp', additionalDetails: '', optional: false, section: '' },
        { name: 'water', amount: '2 Tbsp', additionalDetails: '', optional: false, section: '' },
        { name: 'cornstarch', amount: '2 tsp', additionalDetails: '', optional: false, section: '' },

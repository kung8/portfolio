const cheesecake = '../assets/Products/cafe-rio-salad.jpeg';
...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'sour cream', amount: '3/4 c', additionalDetails: '', optional: false, section: SECTIONS.FILLING },
    ...
    directions: [
        { step: 'Preheat oven to 325ºF.', type: SECTIONS.CRUST },
        { step: 'Grease cake pan with cooking spray.', type: SECTIONS.CRUST },
        ...
        { step: 'Cover the bottom of the cake pan with the aluminum foil (to prevent it from soaking in water).', type: SECTIONS.MAIN },
        { step: 'Place the cake pan in the roasting pan.', type: SECTIONS.MAIN },
        { step: 'Fill the roasting pan with water (about halfway up the cake pan).', type: SECTIONS.MAIN },
        ...
        { step: 'Turn oven off, leave door open, and let cool for 1 hour.', type: SECTIONS.MAIN },
        { step: 'Move cheesecake into the fridge and chill for about 5 hours to overnight.', type: SECTIONS.MAIN },
        ...
        { step: 'Transfer to bowl. Let cool and cover with plastic wrap.', type: SECTIONS.TOPPINGS },
        { step: 'Place in fridge to cool until ready to serve.', type: SECTIONS.TOPPINGS },
        { step: 'Enjoy this decadent, rich "Cheesecake Factory" imitation by topping each slice with the glazed strawberries and whipped cream.', type: SECTIONS.SERVE },
    ]
};
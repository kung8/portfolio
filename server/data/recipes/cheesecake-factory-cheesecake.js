...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-03-29 18:47:54',
    modifiedAt: '2026-05-31 20:27:43',
    ...
    directions: [
        { step: `Grease cake pan with cooking spray.`, section: SECTIONS.CRUST },
        ...
        { step: `In the stand mixer bowl, combine graham cracker, sugar and butter until well incorporated.`, section: SECTIONS.CRUST },
        { step: `Press crust mixture into the pan's bottom and up the sides.`, section: SECTIONS.CRUST },
        { step: `Bake the crust for 12 minutes at 325ºF.`, section: SECTIONS.CRUST, img: cheesecake1 },

        { step: `In the stand mixer bowl, beat cream cheese and sugar at medium speed until smooth and fluffy (about 2 to 3 minutes).`, section: SECTIONS.FILLING },
        { step: `Add eggs one at a time and beat well.`, section: SECTIONS.FILLING },
        { step: `Add vanilla, sour cream, flour, and salt and continue to beat until all is combined.`, section: SECTIONS.FILLING },

        { step: `Preheat oven to 325ºF.`, section: SECTIONS.PREHEAT_OVEN },
        
        { step: `Pour filling into the crust.`, section: SECTIONS.BAKE },
        { step: `Place the cake pan in the roasting pan and fill the roasting pan with water (about halfway up the cake pan).`, section: SECTIONS.BAKE, img: cheesecake2 },
        ...
        { step: `Remove from the oven, transfer to a cooling rack and carefully remove the tin foil.`, section: SECTIONS.COOL },

        { step: `Move cheesecake into the fridge and chill for about 5 hours to overnight.`, section: SECTIONS.CHILL },

        { step: `In a small bowl, whisk cornstarch and water until combined.`, section: SECTIONS.TOPPINGS },
        { step: `In a saucepan, add strawberries, sugar, lemon juice, and cornstarch mixture.`, section: SECTIONS.TOPPINGS },
        { step: `Bring mixture to a simmer over medium heat.`, section: SECTIONS.TOPPINGS },
        { step: `Cook until the sauce thickens to a syrupy texture and strawberries are coated.`, section: SECTIONS.TOPPINGS },
        { step: `Transfer to bowl. Let cool and cover with plastic wrap.`, section: SECTIONS.TOPPINGS, img: cheesecake3 },
        { step: `Place in fridge to cool until ready to serve.`, section: SECTIONS.TOPPINGS, img: cheesecake4 },
        { step: `Enjoy this decadent, rich "Cheesecake Factory" imitation by topping each slice with the glazed strawberries and whipped cream.`, section: SECTIONS.SERVE },
    ],
    store: [
        {

...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Wait until the sauce cools before blending in a traditional blender. And be sure not to overfill.', section: MAKE_BIRRIA_FILLING },
        { step: 'Transfer blended sauce back to crockpot.', section: MAKE_BIRRIA_FILLING },
        { step: 'Add 2 cups of sauce to the shredded beef.', section: MAKE_BIRRIA_FILLING },

        { step: 'Add a little avocado oil to a pan.', section: ASSEMBLE_TACOS },
        { step: 'Dip two tortillas into the sauce and place the two stacked tortillas in pan.', section: ASSEMBLE_TACOS },

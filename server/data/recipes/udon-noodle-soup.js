...
const { BEEF_BROTH, BEEF_RIBS, CARROT, CINNAMON_STICK, EGG, GINGER, GREEN_ONION, LIGHT_SOY_SAUCE, MIRIN, NAPA_CABBAGE, PORK_TENDERLOINS, SALT, SESAME_SEEDS, SHIITAKE_MUSHROOM, THAI_CHILI_PEPPER, UDON_NOODLES, WHITE_SUGAR, YELLOW_ONION, STOVE, LARGE_POT } = require('./ingredients');

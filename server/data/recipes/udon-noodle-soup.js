...
module.exports = {
    ...
    ingredients: [
        ...
        { ...WARM_WATER, amount: '1 - 3 inch', additionalDetails: 'whole', section: BEEF_BROTH_SECTION },

        { ...EGGS, amount: '4', additionalDetails: '', section: EGG_SECTION },
        { ...UDON_NOODLES, amount: '1/2 lb', additionalDetails: '', section: NOODLE_SECTION },
        { ...CARROTS, amount: '1 large', additionalDetails: 'peeled and julienned', section: SOUP_1_SECTION },
        { ...SHIITAKE_MUSHROOMS, amount: '3 1/2 oz', additionalDetails: '', section: SOUP_1_SECTION },
        { ...GINGER, amount: '1 Tbsp', additionalDetails: 'minced', section: SOUP_1_SECTION },
        { ...THAI_CHILI_PEPPERS, amount: '2', additionalDetails: 'whole', section: SOUP_1_SECTION },
        { ...MIRIN, amount: '1/4 c', additionalDetails: '', section: SOUP_1_SECTION },
        { ...LIGHT_SOY_SAUCE, amount: '2 Tbsp', additionalDetails: '', section: SOUP_1_SECTION },
        { ...WHITE_SUGAR, amount: '1 tsp', additionalDetails: '', section: SOUP_1_SECTION },
        { ...SALT, amount: '1 tsp', additionalDetails: '', section: SOUP_1_SECTION },
        { ...PORK_TENDERLOINS, amount: '1 lb', additionalDetails: 'sliced', section: SOUP_2_SECTION },
        { ...NAPA_CABBAGE, amount: '2 medium', additionalDetails: '', section: SOUP_2_SECTION },
        { ...GREEN_ONIONS, amount: '2', additionalDetails: 'chopped', section: SOUP_2_SECTION },

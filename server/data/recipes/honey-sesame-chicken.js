...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...EGGS, amount: '2', unit: '', additionalDetails: 'beaten', section: EGG_DREDGE },
        ...
        { ...ALL_PURPOSE_FLOUR, amount: '1/2 c', unit: '', additionalDetails: '', section: FLOUR_DREDGE },
        { ...CORNSTARCH, amount: '1/2 c', unit: '', additionalDetails: '', section: FLOUR_DREDGE },

        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '1 1/2 lb', unit: '', additionalDetails: 'cut into 1 inch pieces', section: DEEP_FRY },
        { ...VEGETABLE_OIL, amount: '', unit: '', additionalDetails: 'for frying', section: DEEP_FRY },
        
        { ...HONEY, amount: '1/4 c', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...LIGHT_SOY_SAUCE, amount: '1/4 c', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...KETCHUP, amount: '2 Tbsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...BROWN_SUGAR, amount: '3 Tbsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...RICE_WINE_VINEGAR, amount: '2 Tbsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...SESAME_OIL, amount: '1 Tbsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...CORNSTARCH, amount: '2 tsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...VEGETABLE_OIL, amount: '1 tsp', unit: '', additionalDetails: '', section: HONEY_SESAME_SAUCE },
        { ...GARLIC, amount: '1 tsp', unit: '', additionalDetails: 'minced', section: HONEY_SESAME_SAUCE },

        { ...SESAME_SEEDS, amount: '2 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...GREEN_ONIONS, amount: '2 Tbsp', unit: '', additionalDetails: 'sliced', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

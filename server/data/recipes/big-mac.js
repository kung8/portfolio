...
module.exports = {
    ...
    directions: [
        { step: 'In a mixing bowl, combine the sauce ingredients.', type: BIG_MAC_SAUCE },
        { step: 'Place sauce in fridge to chill until ready to assemble the burgers.', type: BIG_MAC_SAUCE },
        { step: 'Cook the patties on a grill/skillet/pan to your preferred doneness.', type: SECTIONS.MAIN },
        { step: 'Assemble the burgers.', type: SECTIONS.MAIN },

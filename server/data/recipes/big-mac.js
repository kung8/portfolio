...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...MAYONNAISE, amount: '1/2 c', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        { ...KETCHUP, amount: '2 Tbsp', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        { ...YELLOW_MUSTARD, amount: '1 Tbsp', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        { ...PICKLES, amount: '2 Tbsp', unit: '', additionalDetails: 'diced', section: BIG_MAC_SAUCE },
        { ...YELLOW_ONION, amount: '2 Tbsp', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        { ...PAPRIKA, amount: '1 tsp', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        { ...ONION_POWDER, amount: '1 tsp', unit: '', additionalDetails: '', section: BIG_MAC_SAUCE },
        ...
        { ...LETTUCE, amount: '8 oz', unit: '', additionalDetails: 'shredded', section: SECTIONS.ASSEMBLY },

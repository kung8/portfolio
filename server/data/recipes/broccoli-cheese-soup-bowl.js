...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'flour', amount: '1/4 c', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'half and half cream', amount: '2 c', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'chicken broth', amount: '2 c', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'broccoli', amount: '2 heads of', additionalDetails: 'chopped', optional: false, section: SECTIONS.SOUP },
        { name: 'carrot matchsticks', amount: '1 c', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'nutmeg', amount: '1/4 tsp', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'cheddar cheese', amount: '8 oz', additionalDetails: '', optional: false, section: SECTIONS.SOUP },
        { name: 'salt', amount: '', additionalDetails: 'to taste', optional: false, section: SECTIONS.SOUP },
        { name: 'pepper', amount: '', additionalDetails: 'to taste', optional: false, section: SECTIONS.SOUP },
        { name: 'bread bowls', amount: '6', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'sour cream', amount: '', additionalDetails: '', optional: true, section: SECTIONS.TOPPINGS },
        { name: 'green onion', amount: '', additionalDetails: '', optional: true, section: SECTIONS.TOPPINGS },
        { name: 'cheddar', amount: '', additionalDetails: '', optional: true, section: SECTIONS.TOPPINGS },
        { name: 'bacon bits', amount: '', additionalDetails: '', optional: true, section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

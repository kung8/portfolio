...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...COOKING_SPRAY, amount: '', additionalDetails: '', section: POPCORN_SECTION },
        { ...POPCORN, amount: '4 qt', additionalDetails: 'popped', section: POPCORN_SECTION },
        { ...BROWN_SUGAR, amount: '1 c', additionalDetails: '', section: CARAMEL_SECTION },
        { ...CORN_SYRUP, amount: '1/2 c', additionalDetails: '', section: CARAMEL_SECTION },
        { ...UNSALTED_BUTTER, amount: '1/2 c', additionalDetails: '', section: CARAMEL_SECTION },
        { ...SALT, amount: '', additionalDetails: '1/2 tsp', section: CARAMEL_SECTION },
        { ...VANILLA_EXTRACT, amount: '1 tsp', additionalDetails: '', section: CARAMEL_SECTION },
        { ...BAKING_SODA, amount: '1/2 tsp', additionalDetails: '', section: CARAMEL_SECTION },
    ],
    appliances: [
        { name: 'oven' },
        { name: 'stove' },

...
const { ALL_PURPOSE_FLOUR, BAKING_SHEET, BASTING_BRUSH, BOWL, CHERRY, CREAM_CHEESE, EGG_YOLK, LEMON_JUICE, LEMON_ZEST, MIXING_BOWL, OVEN, PLASTIC_WRAP, POWDERED_SUGAR, SALT, SAUCEPAN, SILICON_BAKING_MAT, SMALL_BOWL, STAND_MIXER, STOVE, UNSALTED_BUTTER, WATER, WHITE_SUGAR, WHOLE_MILK, YEAST } = require('./ingredients');

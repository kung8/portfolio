...
module.exports = {
    ...
    separated: false,
    ingredients: [
        { ...BREAD, amount: 8, unit: '', additionalDetails: 'cubed' },
        { ...CHEDDAR_CHEESE, amount: 2, unit: INGREDIENT_UNITS.CUP, additionalDetails: 'shredded' },
        { ...COOKED_HAM, amount: 5 / 4, unit: INGREDIENT_UNITS.CUP, additionalDetails: 'diced' },
        { ...YELLOW_ONION, amount: 1, unit: INGREDIENT_UNITS.MEDIUM, additionalDetails: 'diced' },
        { ...RED_BELL_PEPPER, amount: 1 / 4, unit: INGREDIENT_UNITS.CUP, additionalDetails: 'diced' },
        { ...EGG, amount: 6, unit: '', additionalDetails: '' },
        { ...MILK, amount: 3, unit: INGREDIENT_UNITS.CUP, additionalDetails: '' },
        { ...SALT, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '' },
        { ...BLACK_PEPPER, amount: 1 / 4, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '' },
        { ...KETCHUP, amount: '', unit: '', additionalDetails: '(optional)' },
        { ...SALSA, amount: '', unit: '', additionalDetails: '(optional)' },
    ],
    appliances: [
        OVEN,
        REFRIGERATOR,

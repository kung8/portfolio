...
module.exports = {
    ...
    separated: false,
    ingredients: [
        { name: 'unsalted butter', amount: '1 c', additionalDetails: 'melted', optional: false, section: SECTIONS.MAIN },
        { name: 'brown sugar', amount: '1 1/4 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'sugar', amount: '1/2 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'eggs', amount: '2', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'egg yolk', amount: '1', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'vanilla extract', amount: '2 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'all-purpose flour', amount: '2 1/4 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'cornstarch', amount: '2 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'baking powder', amount: '1/2 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'salt', amount: '1 tsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'chocolate chips', amount: '2/3 c', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
    ],
    appliances: [
        { name: 'oven' },
    ],

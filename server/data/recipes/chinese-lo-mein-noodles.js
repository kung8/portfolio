...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'flank steak', amount: '1/2 pound', additionalDetails: 'sliced', optional: false, section: SECTIONS.MARINADE },
        ...
        { name: 'lo mein noodles', amount: '1 pound', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'vegetable oil', amount: '4 Tbsp', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'broccoli', amount: '1/2 pound', additionalDetails: 'cut into florets', optional: false, section: SECTIONS.MAIN },
    ...
    directions: [
        { step: 'Combine beef, salt, sugar, pepper, shaoxing wine (1/2 tsp), light soy sauce (1/2 tsp), and cornstarch in a medium bowl. Mix with hands until beef is well-coated. Let it marinate for at least 30 minutes.', type: SECTIONS.MAIN },
        { step: 'Combine sesame oil, light soy sauce (2 tsp), dark soy sauce, oyster sauce, salt, sugar, shaoxing wine (1 tsp), and water in a small bowl. Mix well and set aside. This is the sauce.', type: SECTIONS.MAIN },

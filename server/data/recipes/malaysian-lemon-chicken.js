...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'soy sauce', amount: '2 1/2 T', additionalDetails: '', optional: false, section: SECTIONS.MARINADE },
        { name: 'shaoxing wine', amount: '2 1/2 T', additionalDetails: '', optional: false, section: SECTIONS.MARINADE },
        { name: 'cornstarch', amount: '5 T', additionalDetails: '', optional: false, section: SECTIONS.MARINADE },
        ...
        { name: 'lemon juice', amount: '15 T', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'sugar', amount: '5 T', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'water', amount: '25 T', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'cornstarch', amount: '5 t', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'salt', amount: '5 pinches', additionalDetails: 'to taste', optional: false, section: SECTIONS.SAUCE },
        { name: 'white sesame', amount: '2 1/2 t', additionalDetails: 'to top', optional: false, section: SECTIONS.TOPPINGS },
    ],
    supplies: [
        { name: 'stove' },
        { name: 'deep pot' },
    ...
    directions: [
        { step: 'In a large bowl, marinate the chicken with the soy sauce, shaoxing wine, and cornstarch (5 T) for at least 30 minutes.', type: SECTIONS.MAIN },

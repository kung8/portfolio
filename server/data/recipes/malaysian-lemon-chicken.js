...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'cornstarch', amount: '1 1/4 cups', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        { name: 'flour', amount: '1 1/4 cups', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
    ...
    directions: [
        ...
        { step: 'Mix the sugar, cornstarch (5 tsp), salt, water,lemon juice, and white sesame in a sauce pan. Set aside. This is the sauce.', type: SECTIONS.MAIN },
        { step: 'In a medium bowl, mix the flour and cornstarch (1 1/4 cups) for the dredging station.', type: SECTIONS.MAIN },

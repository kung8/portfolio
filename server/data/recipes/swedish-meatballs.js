...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...BREADCRUMBS, amount: '2/3 c', unit: '', additionalDetails: '', section: BREADCRUMB_MIXTURE },
        { ...HEAVY_CREAM, amount: '1/2 c', unit: '', additionalDetails: '', section: BREADCRUMB_MIXTURE },
        { ...UNSALTED_BUTTER, amount: '1 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...YELLOW_ONION, amount: '1 small', unit: '', additionalDetails: 'minced', section: SWEDISH_MEATBALLS },
        { ...GROUND_BEEF, amount: '2/3 lb', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...GROUND_PORK, amount: '1/3 lb', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...EGGS, amount: '1', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...BROWN_SUGAR, amount: '1 Tbsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...SALT, amount: '1 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...BLACK_PEPPER, amount: '1/4 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...NUTMEG, amount: '1/4 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...ALLSPICE, amount: '1/4 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },
        { ...GROUND_GINGER, amount: '1/8 tsp', unit: '', additionalDetails: '', section: SWEDISH_MEATBALLS },

        { ...UNSALTED_BUTTER, amount: '1 Tbsp', unit: '', additionalDetails: '', section: PAN_FRY_MEATBALLS },
        { ...CHICKEN_BROTH, amount: '1/4 c', unit: '', additionalDetails: '', section: BAKING },
        { ...ALL_PURPOSE_FLOUR, amount: '3 Tbsp', unit: '', additionalDetails: 'or as needed', section: '' },
        { ...BEEF_BROTH, amount: '2 c', unit: '', additionalDetails: 'or as needed', section: '' },
        { ...SOUR_CREAM, amount: '8 oz', unit: '', additionalDetails: '', section: '' },
    ],
    appliances: [
        { name: 'stove' },
        { name: 'oven' },

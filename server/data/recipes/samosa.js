...
const { ALL_PURPOSE_FLOUR, AMCHUR_POWDER, BAKING_PAN, CAROM_SEEDS, CHILI_POWDER, CORIANDER, CUMIN, DEEP_FRYER, DOUGH_KNIFE, FENNEL_SEEDS, FRYING_PAN, GARAM_MASALA, GHEE, GINGER, GREEN_PEA, LARGE_POT, LEMON_JUICE, MIXING_BOWL, OVEN, SALT, SERRANO_PEPPER, STOVE, WATER, YUKON_GOLD_POTATO } = require('./ingredients');

const PREP_POTATOES = 'Prep Potatoes';
const MAKE_SAMOSA = 'Make Samosa';
const AIR_FRY_OR_BAKE = 'Air Fry or Bake';
...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '12/17/2024 21:46:17',
    modifiedAt: '03/28/2026 23:00:59',
    ...
    ingredients: [
        ...
        { ...CAROM_SEEDS, amount: 3 /16, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.DOUGH },
        { ...SALT, amount: 3 /16, unit: INGREDIENT_UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.DOUGH },
    ...
    directions: [
        ...
        { step: `Add potatoes and boil until it is tender but not mushy.`, section: PREP_POTATOES },
        { step: `Drain the potatoes and let them cool.`, section: PREP_POTATOES },
        { step: `Crumble the potatoes (not mash).`, section: PREP_POTATOES, img: samosa5 },
        ...
        { step: `Add cumin. Cook until it sizzles.`, section: SECTIONS.PREP_FILLING },
        { step: `Add ginger and chilies. Cook until fragrant (about 30 seconds to 1 minute).`, section: SECTIONS.PREP_FILLING },
        { step: `Add peas. Saute for 2 minutes.`, section: SECTIONS.PREP_FILLING },
        { step: `Add the "${SECTIONS.SPICES}" section ingredients. Saute for 30 seconds.`, section: SECTIONS.PREP_FILLING },
        { step: `Add potatoes. Saute for 2 to 3 minutes.`, section: SECTIONS.PREP_FILLING },
        { step: `Add coriander. Set aside.`, section: SECTIONS.PREP_FILLING, img: samosa6 },
        ...
        { step: `Knead the dough a little to smooth it.`, section: MAKE_SAMOSA, img: samosa7 },
        { step: `Divide it into 5 parts. Roll each into balls.`, section: MAKE_SAMOSA, img: samosa8 },
        { step: `Cover the dough until ready to use.`, section: MAKE_SAMOSA },
        { step: `Add a little ghee/oil on a clean working surface.`, section: MAKE_SAMOSA, img: samosa9 },
        ...
        { step: `Cut the dough in half to form two semicircles. Now you have two samosas.`, section: MAKE_SAMOSA, img: samosa10 },
        { step: `Apply water over the straight edge.`, section: MAKE_SAMOSA },
        { step: `Fold the straight edge in half to form a cone. From inside the cone, gently press that edge to seal the cone. If it is not sticking still, use a little water and flour to form a paste and apply to help make it stick.`, section: MAKE_SAMOSA, img: samosa12 },
        { step: `Fill the cone with the potato masala. Push the filling in with your fingers.`, section: MAKE_SAMOSA, img: samosa11 },
        ...
        { step: `Either bake or deep fry the samosas.`, section: AIR_FRY_OR_BAKE },

        { step: `Preheat the oven to 360ºF.`, section: SECTIONS.BAKE },
        { step: `Place each samosa in a baking dish.`, section: SECTIONS.BAKE },
        { step: `Generously brush the samosa with oil all over.`, section: SECTIONS.BAKE, img: samosa13 },
        { step: `Bake for 35 to 40 minutes.`, section: SECTIONS.BAKE },

        { step: `Heat oil in a deep fryer or in a pot on the stove to 360ºF.`, section: SECTIONS.DEEP_FRY },
        { step: `Line a baking sheet with paper towel and place a cooling rack on top.`, section: SECTIONS.DEEP_FRY },
        { step: `Deep fry until golden brown (about 10 to 12 minutes).`, section: SECTIONS.DEEP_FRY },
        { step: `Transfer to a drip station.`, section: SECTIONS.DEEP_FRY },

        { step: `Enjoy these delicious appetizers with your favorite chutney.`, section: SECTIONS.SERVE, img: samosa14 },
    ],
    notes: [

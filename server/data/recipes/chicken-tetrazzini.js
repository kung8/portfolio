...
module.exports = {
    ...
    ingredients: [
        ...
        { ...ROTISSERIE_CHICKEN, amount: '3 c', additionalDetails: '', section: SECTIONS.SAUCE },
    ...
    directions: [
        ...
        { step: 'In a mixing bowl, combine all the "Sauce" section ingredients.', type: PREP_CASSEROLE },
        { step: 'Add noodles and toss.', type: PREP_CASSEROLE },
        { step: 'In a casserole dish, transfer noodle mixture.', type: PREP_CASSEROLE },
        { step: 'Top with shredded cheese.', type: PREP_CASSEROLE },
        { step: 'Cover with foil.', type: COOK_CASSEROLE },
        { step: 'Bake for 45 minutes.', type: COOK_CASSEROLE },
        { step: 'Remove foil and bake until cheese is hot and bubbly (about 10 to 15 minutes).', type: COOK_CASSEROLE },

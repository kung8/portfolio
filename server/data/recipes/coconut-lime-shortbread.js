...
module.exports = {
    ...
    directions: [
        ...
        { step: `Beat on high until dough comes together and becomes smooth. Add water if it is not smooth after 2 minutes of beating.`, section: SECTIONS.PREP_BATTER },
        ...
        { step: `Roll out dough until it is 1/4 inch thick.`, section: PREP_COOKIES },
        { step: `Use a cookie cutter to cut dough into shapes. Reroll remainder and cut them into shapes.`, section: PREP_COOKIES },
        { step: `Place each cookie 3 inch apart on the baking sheets.`, section: PREP_COOKIES },

        { step: `Bake until the edges are lightly browned (about 12 to 14 minutes).`, section: SECTIONS.BAKE },

        { step: `Let them cool on the baking sheet for 5 minutes before transferring them to a cooling rack to cool completely.`, section: SECTIONS.COOL },

        { step: `Set up a double boiler on the stove and melt white chocolate chips until smooth.`, section: SECTIONS.DECORATE },
        { step: `Dip cookies halfway.`, section: SECTIONS.DECORATE },

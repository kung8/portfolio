...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Form 1 inch balls and place on sheet.', type: PREP_MEATBALLS, img: sub1 },
        { step: 'Bake until cooked through (about 20 minutes).', type: PREP_MEATBALLS, img: sub3 },
        { step: 'Over medium-low heat, add meatball and pasta sauce in a saucepan.', type: PREP_SAUCE, img: sub4 },
        { step: 'Cover and simmer for 10 minutes.', type: PREP_SAUCE },
        { step: 'Spread garlic butter inside roll.', type: PREP_ROLLS, img: sub2 },
        { step: 'Place rolls in a baking pan and broil until golden (about 2 minutes).', type: PREP_ROLLS, img: sub5 },
        { step: 'Add 3 meatballs in each roll with a little sauce and cheese.', type: ASSEMBLE_SUBS, img: sub6 },
        { step: 'Broil until cheese is melted (about 2 minutes).', type: ASSEMBLE_SUBS, img: sub7 },

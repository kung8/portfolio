...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...CHICKEN_THIGH, amount: 1, unit: UNITS.POUND, additionalDetails: 'bone-in, skin on', section: SECTIONS.CHICKEN },
        { ...SESAME_OIL, amount: 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...SALT, amount: 1 / 4, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...JASMINE_RICE, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.RICE },
        { ...GARLIC, amount: 6, unit: UNITS.CLOVE, additionalDetails: 'minced', section: SECTIONS.RICE },
        { ...GINGER, amount: 1 / 2, unit: UNITS.INCH, additionalDetails: 'minced', section: SECTIONS.RICE },
        { ...GREEN_ONIONS, amount: 2, unit: '', additionalDetails: 'chopped', section: SECTIONS.RICE },
        { ...CHICKEN_BROTH, amount: 2, unit: UNITS.CUP, additionalDetails: '', section: SECTIONS.RICE },
        { ...TURMERIC, amount: 1 / 2, unit: UNITS.TEASPOON, additionalDetails: '', section: SECTIONS.RICE },
        { ...GARLIC, amount: 6, unit: UNITS.CLOVE, additionalDetails: 'minced', section: CHILI_SAUCE },
        { ...GINGER, amount: 1 / 2, unit: UNITS.INCH, additionalDetails: 'minced', section: CHILI_SAUCE },
        { ...SRIRACHA_SAUCE, amount: 2, unit: UNITS.TABLESPOON, additionalDetails: '', section: CHILI_SAUCE },
        { ...CHICKEN_BROTH, amount: 2, unit: UNITS.TABLESPOON, additionalDetails: '', section: CHILI_SAUCE },
        { ...LIME_JUICE, amount: 1, unit: UNITS.TABLESPOON, additionalDetails: '', section: CHILI_SAUCE },
        { ...WHITE_SUGAR, amount: 2, unit: UNITS.TEASPOON, additionalDetails: '', section: CHILI_SAUCE },

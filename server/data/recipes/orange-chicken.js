...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...ORANGE_JUICE, amount: '1 c', additionalDetails: '', section: ORANGE_SAUCE },
        ...
        { ...CORNSTARCH, amount: '1 Tbsp', additionalDetails: '', section: ORANGE_SAUCE },
        { ...COLD_WATER, amount: '2 Tbsp', additionalDetails: '', section: ORANGE_SAUCE },

        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '4', additionalDetails: 'cut into 1 inch pieces', section: SECTIONS.CHICKEN },
        
        { ...CORNSTARCH, amount: '1/3 c', additionalDetails: '', section: FLOUR_DREDGE },
        { ...ALL_PURPOSE_FLOUR, amount: '1/3 c', additionalDetails: '', section: FLOUR_DREDGE },
        { ...SALT, amount: '', additionalDetails: '', section: FLOUR_DREDGE },
        
        { ...EGGS, amount: '3', additionalDetails: '', section: SECTIONS.CHICKEN },
        { ...VEGETABLE_OIL, amount: '', additionalDetails: 'for frying', section: SECTIONS.CHICKEN },

        { ...GREEN_ONIONS, amount: '', additionalDetails: 'chopped', section: SECTIONS.TOPPINGS },
        { ...ORANGE_ZEST, amount: '', additionalDetails: '', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

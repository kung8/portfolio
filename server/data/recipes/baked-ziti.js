...
module.exports = {
    ...
    ingredients: [
        ...
        { ...RED_PEPPER_FLAKES, amount: '1/4 tsp', additionalDetails: '', section: CASSEROLE_MIXTURE_SECTION },
        { ...HEAVY_CREAM, amount: '1 c', additionalDetails: '', section: CASSEROLE_MIXTURE_SECTION },
        { ...PARMIGIANO_REGGIANO, amount: '1/3 c', additionalDetails: 'grated', section: CASSEROLE_MIXTURE_SECTION },
        { ...BASIL_LEAVES, amount: '1/3 c', additionalDetails: 'chopped', section: CASSEROLE_MIXTURE_SECTION },

        { ...MOZZARELLA_CHEESE, amount: '2 c', additionalDetails: 'shredded', section: LAYERING_SECTION },
        { ...PARMIGIANO_REGGIANO, amount: '3 Tbsp', additionalDetails: 'grated', section: LAYERING_SECTION },
    ],
    appliances: [
        { name: 'stove' },
        { name: 'oven' },

...
module.exports = {
    ...
    directions: [
        { step: 'Over high heat, heat oil in a wok until it begins to smoke.', type: COOK_SHRIMP },
        { step: 'Add shrimp. Cook without stirring for 1 minute.', type: COOK_SHRIMP },
        { step: 'Season shrimp with salt. Cook until shrimp becomes pink (about 1 minute).', type: COOK_SHRIMP },
        { step: 'Add garlic and red pepper flakes. Cook and stir (about 1 minute).', type: COOK_SHRIMP },
        { step: 'Add lemon juice, 1 butter piece, and half of the parsley. Cook until butter melts (about 1 minute).', type: COOK_SHRIMP },
        { step: 'Reduce to low heat. Add in the rest of the butter.', type: COOK_SHRIMP },
        { step: 'Cook and stir until the sauce is thickened and shrimp are pink and opaque (about 2 to 3 minutes).', type: COOK_SHRIMP },
        { step: 'Transfer shrimp to a mixing bowl with a slotted spoon.', type: COOK_SHRIMP },
        { step: 'Cook butter sauce for about 2 minutes. If it is too thick, add water 1 teaspoon at a time.', type: COOK_SHRIMP },
        { step: 'Enjoy this dish with rice or noodles. Top with the sauce and parsley.', type: SECTIONS.SERVE },
    ]
};
...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...UNSALTED_BUTTER, amount: '16 Tbsp', additionalDetails: '', section: TOFFEE_SAUCE },
        { ...BROWN_SUGAR, amount: '2 c', additionalDetails: '', section: TOFFEE_SAUCE },
        { ...HEAVY_CREAM, amount: '3 1/3 c', additionalDetails: '', section: TOFFEE_SAUCE },
        { ...VANILLA_EXTRACT, amount: '2 tsp', additionalDetails: '', section: TOFFEE_SAUCE },

        { ...DATES, amount: '6 oz', additionalDetails: '', section: PUDDING },
        { ...COLD_WATER, amount: '1 c', additionalDetails: '', section: PUDDING },
        { ...BAKING_SODA, amount: '1 tsp', additionalDetails: '', section: PUDDING },
        { ...ALL_PURPOSE_FLOUR, amount: '1 1/4 c', additionalDetails: '', section: PUDDING },
        { ...BAKING_POWDER, amount: '1 tsp', additionalDetails: '', section: PUDDING },
        { ...SALT, amount: '1 tsp', additionalDetails: '', section: PUDDING },
        { ...ALLSPICE, amount: '1/2 tsp', additionalDetails: '', section: PUDDING },
        { ...NUTMEG, amount: '1/2 tsp', additionalDetails: '', section: PUDDING },
        { ...UNSALTED_BUTTER, amount: '4 Tbsp', additionalDetails: '', section: PUDDING },
        { ...WHITE_SUGAR, amount: '3/4 c', additionalDetails: '', section: PUDDING },
        { ...EGGS, amount: '2', additionalDetails: 'room temperature', section: PUDDING },
        { ...VANILLA_EXTRACT, amount: '1 1/2 tsp', additionalDetails: '', section: PUDDING },
        { ...WALNUTS, amount: '3/4 c', additionalDetails: '', section: PUDDING },
    ],
    appliances: [
        { name: 'stove' },
        { name: 'oven' },

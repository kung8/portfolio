...
const { PORK_CHOPS, ALL_PURPOSE_FLOUR, EGGS, PANKO_BREADCRUMBS, OLIVE_OIL, UNSALTED_BUTTER, SALT, BLACK_PEPPER, LEMON_JUICE, CUCUMBER, PARMESAN_CHEESE, ASPARAGUS, BABY_ARUGULA, BABY_KALE, RADISH, PEAS, MICROGREENS } = require('./ingredients');
...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...PORK_CHOPS, amount: '2 - 1 lb', additionalDetails: 'bone-in', section: PORK_SECTION },
        { ...ALL_PURPOSE_FLOUR, amount: '1 c', additionalDetails: '', section: PORK_SECTION },
        { ...EGGS, amount: '3', additionalDetails: '', section: PORK_SECTION },
        { ...PANKO_BREADCRUMBS, amount: '2 c', additionalDetails: '', section: PORK_SECTION },
        { ...OLIVE_OIL, amount: '1/4 c', additionalDetails: '', section: PORK_SECTION },
        { ...UNSALTED_BUTTER, amount: '2 Tbsp', additionalDetails: '', section: PORK_SECTION },
        { ...SALT, amount: '', additionalDetails: 'to taste', section: PORK_SECTION },
        { ...BLACK_PEPPER, amount: '', additionalDetails: 'to taste', section: PORK_SECTION },

        { ...LEMON_JUICE, amount: '2 Tbsp', additionalDetails: '', section: SALAD_SECTION },
        { ...OLIVE_OIL, amount: '1/4 c', additionalDetails: '', section: SALAD_SECTION },
        { ...BABY_ARUGULA, amount: '2 c', additionalDetails: '', section: SALAD_SECTION },
        { ...BABY_KALE, amount: '2 c', additionalDetails: '', section: SALAD_SECTION },
        { ...PARMESAN_CHEESE, amount: '1/4 c', additionalDetails: 'grated', section: SALAD_SECTION },
        { ...SALT, amount: '', additionalDetails: 'to taste', section: SALAD_SECTION },
        { ...BLACK_PEPPER, amount: '', additionalDetails: 'to taste', section: SALAD_SECTION },
    ],
    appliances: [
        { name: 'stove' },
    ],

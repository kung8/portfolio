...
module.exports = {
    ...
    available: true,
    recommended: false,
    createdAt: '2024-06-18 19:56:30',
    modifiedAt: '2026-05-31 17:58:57',
    ...
    directions: [
        ...
        { step: `Add the chicken and cook until each side is golden brown (about 4 to 6 minutes each side)`, section: SECTIONS.COOK_CHICKEN },
        ...
        { step: `Cut the ends of the baby bok choy so that each leaf is free and wash carefully to clean each leaf.`, section: SECTIONS.MAIN },
        ...
        { step: `Blanch your bok choy by placing it the boiling water for 3 to 4 minutes. This should only soften the vegetables.`, section: SECTIONS.MAIN },
        ...
        { step: `Serve this with some sesame seeds and rice.`, section: SECTIONS.SERVE, img: bokChoy2 },
    ],
    store: [
        {

...
module.exports = {
    ...
    directions: [
        { step: 'Set the Instant Pot to the "saute" function (on "normal" heat and timer for 7 minutes).', section: SAUTE },
        { step: 'Once Instant Pot reads "hot", add olive oil.', section: SAUTE },
        { step: 'Add onions and carrots. Saute in pot until softened and lightly browned (for about 6 minutes).', section: SAUTE },
        { step: 'Add garlic. Saute for 1 minute.', section: SAUTE },
        { step: 'Deglaze with 2 teaspoons of vegetable broth.', section: SAUTE },
        { step: 'Add the lentils and the "Sauce" section ingredients.', section: PRESSURE_COOK },
        { step: 'Cover with the lid and set the pressure vent. Set on high pressure with a 15 minute timer. It will take about 10 minutes to pressurize.', section: PRESSURE_COOK },
        { step: 'Once the timer goes off, allow time for the pressure to release (about 15 minutes).', section: PRESSURE_COOK },
        { step: 'Uncover.', section: PRESSURE_COOK },
        { step: 'Add barbecue sauce. Stir.', section: PRESSURE_COOK },

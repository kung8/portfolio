...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'chicken thighs', amount: '1/2 lb', additionalDetails: 'cut into 2 inches', optional: false, section: CHICKEN },
        { name: 'soy sauce', amount: '1 tsp', additionalDetails: '', optional: false, section: CHICKEN },
        { name: 'oyster sauce', amount: '1 tsp', additionalDetails: '', optional: false, section: CHICKEN },
        { name: 'oil', amount: '1 tsp', additionalDetails: '', optional: false, section: CHICKEN },
        { name: 'cornstarch', amount: '1 tsp', additionalDetails: '', optional: false, section: CHICKEN },
        ...
        { name: 'bell pepper', amount: '1', additionalDetails: 'sliced', optional: false, section: SECTIONS.MAIN },
        { name: 'onion', amount: '1', additionalDetails: 'sliced', optional: false, section: SECTIONS.MAIN },
        { name: 'snow peas', amount: '4 oz', additionalDetails: '', optional: false, section: SECTIONS.MAIN },
        ...
        { name: 'light soy sauce', amount: '2 Tbsp', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'dark soy sauce', amount: '1.5 Tbsp', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'oyster sauce', amount: '2 Tbsp', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'brown sugar', amount: '2 Tbsp', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },
        { name: 'white pepper', amount: '1/2 tsp', additionalDetails: '', optional: false, section: SECTIONS.SAUCE },

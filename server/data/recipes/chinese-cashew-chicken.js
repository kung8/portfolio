...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-07-08 18:34:15',
    modifiedAt: '2026-05-31 20:05:59',
    ...
    directions: [
        { step: `In a medium bowl, combine the "${SECTIONS.SAUCE}" section ingredients. Mix well.`, section: SECTIONS.PREP_SAUCE },

        { step: `In a large bowl, combine the "${SECTIONS.CHICKEN}" section ingredients. Mix well until chicken is well coated.`, section: SECTIONS.COOK_CHICKEN },
        { step: `Over medium-high heat, add the "${SECTIONS.OIL}" section ingredients in a wok.`, section: SECTIONS.COOK_CHICKEN },
        { step: `Add the chicken and cook until the chicken is about 80% cooked through (about 3 to 4 minutes on each side).`, section: SECTIONS.COOK_CHICKEN },
        { step: `Transfer chicken to a large bowl.`, section: SECTIONS.COOK_CHICKEN },

        { step: `In the wok, add the "${SECTIONS.VEGGIES}" section ingredients. Cook until the vegetables are tender (about 3 to 4 minutes).`, section: SECTIONS.COOK_VEGGIES },

        { step: `Add the cashews. Stir until mixed.`, section: SECTIONS.ASSEMBLE },
        { step: `Re-add the chicken. Stir until mixed and chicken is cooked through.`, section: SECTIONS.ASSEMBLE },
        { step: `Add the sauce and mix until well coated. Cook for a minute or two.`, section: SECTIONS.ASSEMBLE },
        { step: `Turn off the stove and remove from heat.`, section: SECTIONS.ASSEMBLE, img: chicken1 },

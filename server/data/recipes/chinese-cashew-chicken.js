...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'light soy sauce', amount: '3 Tbsp', additionalDetails: '', section: SECTIONS.SAUCE },
        { name: 'honey', amount: '2 Tbsp', additionalDetails: '', section: SECTIONS.SAUCE },
        { name: 'rice wine vinegar', amount: '1 Tbsp', additionalDetails: '', section: SECTIONS.SAUCE },
        { name: 'Asian chili garlic sauce', amount: '1 Tbsp', additionalDetails: '', section: SECTIONS.SAUCE },
        { name: 'ground ginger', amount: '3/4 tsp', additionalDetails: '', section: SECTIONS.SAUCE },
        { name: 'boneless and skinless chicken breasts', amount: '1.5 lb', additionalDetails: '1 inch cubes', section: CHICKEN },
        { name: 'cornstarch', amount: '3 Tbsp', additionalDetails: '', section: CHICKEN },
        { name: 'salt', amount: '1/2 tsp', additionalDetails: '', section: CHICKEN },
        { name: 'pepper', amount: '1/2 tsp', additionalDetails: '', section: CHICKEN },
        ...
        { name: 'broccoli', amount: '1', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'bell pepper', amount: '1', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'edamame', amount: '1 c', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'whole cashews', amount: '1 c', additionalDetails: '', section: SECTIONS.MAIN },
        { name: 'green onions', amount: '4', additionalDetails: 'chopped diagonally', section: SECTIONS.TOPPINGS },
        { name: 'sesame seeds', amount: '', additionalDetails: 'optional', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

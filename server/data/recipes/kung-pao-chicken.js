...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...BONELESS_AND_SKINLESS_CHICKEN_BREAST, amount: '1 1/2 lbs', additionalDetails: 'cut into 1-inch pieces', section: CHICKEN_MARINADE },
        { ...CORNSTARCH, amount: '2 Tbsp', additionalDetails: '', section: CHICKEN_MARINADE },
        { ...LIGHT_SOY_SAUCE, amount: '4 Tbsp', additionalDetails: '', section: CHICKEN_MARINADE },
        { ...SHAOXING_WINE, amount: '2 Tbsp', additionalDetails: '', section: CHICKEN_MARINADE },
        { ...VEGETABLE_OIL, amount: '2 tsp', additionalDetails: '', section: CHICKEN_MARINADE },
        
        { ...LIGHT_SOY_SAUCE, amount: '1/4 c', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...DARK_SOY_SAUCE, amount: '2 tsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...CHICKEN_BROTH, amount: '1/2 c', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...BALSAMIC_VINEGAR, amount: '2 Tbsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...SHAOXING_WINE, amount: '2 Tbsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...HOISIN_SAUCE, amount: '2 tsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...WHITE_SUGAR, amount: '1 Tbsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        { ...CORNSTARCH, amount: '1 tsp', additionalDetails: '', section: KUNG_PAO_SAUCE },
        
        { ...VEGETABLE_OIL, amount: '4 Tbsp', additionalDetails: 'for frying', section: STIR_FRY },
        { ...CHILI_PEPPERS, amount: '6', additionalDetails: 'roughly chopped', section: STIR_FRY },
        { ...GREEN_BELL_PEPPERS, amount: '1/2', additionalDetails: 'chopped', section: STIR_FRY },
        { ...RED_BELL_PEPPERS, amount: '1/2', additionalDetails: 'chopped', section: STIR_FRY },
        { ...GINGER, amount: '1 Tbsp', additionalDetails: 'minced', section: STIR_FRY },
        { ...GARLIC, amount: '4 cloves', additionalDetails: 'minced', section: STIR_FRY },
        
        { ...GREEN_ONIONS, amount: '6', additionalDetails: 'chopped', section: SECTIONS.TOPPINGS },
        { ...UNSALTED_PEANUTS, amount: '', additionalDetails: 'roasted', section: SECTIONS.TOPPINGS },

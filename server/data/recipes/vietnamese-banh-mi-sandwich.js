...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { name: 'ground pork', amount: '1 lb', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'potato starch', amount: '2 Tbsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'sugar', amount: '1 tsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'sea salt', amount: '1/4 tsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'garlic powder', amount: '1/2 tsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'sesame oil', amount: '2 Tbsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'fish sauce', amount: '1 1/2 Tbsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'baking powder', amount: '1 tsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'white pepper', amount: '1/2 tsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'ice cold water', amount: '3 Tbsp', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'banana leaf', amount: '4 pieces', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'twine', amount: '4 pieces of', additionalDetails: '', optional: false, section: PORK_LOAF },
        { name: 'sea salt', amount: '', additionalDetails: 'for boiling', optional: false, section: PORK_LOAF },
        { name: 'carrots', amount: '5', additionalDetails: 'cut into batons', optional: false, section: PICKLED_VEGETABLES },
        { name: 'daikon', amount: '3', additionalDetails: 'cut into batons', optional: false, section: PICKLED_VEGETABLES },
        { name: 'hot water', amount: '3 3/4 cups', additionalDetails: 'boiled', optional: false, section: PICKLED_VEGETABLES },
        { name: 'white sugar', amount: '1 1/4 c', additionalDetails: '', optional: false, section: PICKLED_VEGETABLES },
        { name: 'salt', amount: '', additionalDetails: '10 tsp', optional: false, section: PICKLED_VEGETABLES },

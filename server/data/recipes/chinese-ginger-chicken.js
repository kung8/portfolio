...
module.exports = {
    ...
    directions: [
        ...
        { step: 'Place wok on stove over medium-high heat. Work in batches as needed.', type: SECTIONS.MAIN },
        { step: 'Add half of the minced garlic. Cook until fragrant (about 30 seconds).', type: SECTIONS.MAIN },
        { step: 'Add half the chicken. Make sure it\'s in a single layer.', type: SECTIONS.MAIN, img: raw },
        ...
        { step: 'Add half of the ginger. Place it either to the side or towards the bottom of the wok, so it can cook better (and crisp up if you prefer it crispier).', type: SECTIONS.MAIN, img: mixed },

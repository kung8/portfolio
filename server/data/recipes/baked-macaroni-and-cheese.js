...
module.exports = {
    ...
    directions: [
        ...
        { step: `Light spray some cooking oil spray in a baking dish.`, section: SECTIONS.PREP_PAN, img: cheese1 },
        { step: `In a large pot, boil water.`, section: SECTIONS.COOK_NOODLES, img: cheese2 },
        { step: `Cook pasta until it is cooked to al dente (follow the instructions on the package).`, section: SECTIONS.COOK_NOODLES, img: cheese3 },
        { step: `Drain the pasta in a colander and place in a bowl.`, section: SECTIONS.COOK_NOODLES },
        { step: `Drizzle with olive oil and mix until pasta is coated. Set aside.`, section: SECTIONS.COOK_NOODLES, img: cheese4 },
        { step: `In a mixing bowl, combine shredded cheese and set aside.`, section: SECTIONS.COOK_SAUCE, img: cheese5 },
        { step: `Over medium heat, melt butter in a large pot.`, section: SECTIONS.COOK_SAUCE, img: cheese6 },
        { step: `Whisk flour until it becomes golden (about 1 minute).`, section: SECTIONS.COOK_SAUCE, img: [cheese7, cheese8] },
        { step: `Add milk and heavy cream and whisk until smooth.`, section: SECTIONS.COOK_SAUCE, img: cheese9 },
        { step: `Continue to whisk until it bubbles (for about 2 minutes)`, section: SECTIONS.COOK_SAUCE },
        { step: `Add salt and pepper.`, section: SECTIONS.COOK_SAUCE, img: cheese10 },
        { step: `Add 2 cups of the mixed cheeses and mix. Repeat with another 2 cups. Sauce should be thick.`, section: SECTIONS.COOK_SAUCE, img: [cheese11, cheese12] },
        ...
        { step: `Bake until bubbly and golden brown (about 30 minutes).`, section: SECTIONS.BAKE, img: [cheese19, cheese20] },

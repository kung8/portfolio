...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...BEEF, amount: '1 lb', unit: '', additionalDetails: 'sliced', section: BEEF_SECTION },
        { ...WARM_WATER, amount: '3 Tbsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...SHAOXING_WINE, amount: '2 Tbsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...SALT, amount: '1 tsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...CORNSTARCH, amount: '3 Tbsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...BAKING_SODA, amount: '1/2 tsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...VEGETABLE_OIL, amount: '2 Tbsp', unit: '', additionalDetails: '', section: BEEF_SECTION },
        { ...LIGHT_SOY_SAUCE, amount: '1/2 c', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...WARM_WATER, amount: '1/2 c', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...WHITE_SUGAR, amount: '3 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...CORNSTARCH, amount: '1 1/2 Tbsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...SESAME_OIL, amount: '1 1/2 tsp', unit: '', additionalDetails: '', section: SECTIONS.SAUCE },
        { ...BROCCOLI, amount: '2 heads of', unit: '', additionalDetails: 'cut into florets', section: SECTIONS.MAIN },
        { ...GINGER, amount: '1 1/2 Tbsp', unit: '', additionalDetails: 'minced', section: SECTIONS.MAIN },

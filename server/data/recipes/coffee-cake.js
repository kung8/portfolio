...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...UNSALTED_BUTTER, amount: '1/2 c', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },
        { ...CREAM_CHEESE, amount: '8 oz', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },
        { ...BROWN_SUGAR, amount: '1 c', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },
        { ...WHITE_SUGAR, amount: '1/2 c', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },
        { ...EGGS, amount: '2', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },
        { ...VANILLA_EXTRACT, amount: '1 1/2 tsp', unit: '', additionalDetails: '', section: WET_CAKE_BATTER },

        { ...ALL_PURPOSE_FLOUR, amount: '2 1/2 c', unit: '', additionalDetails: '', section: DRY_CAKE_BATTER },
        { ...BAKING_POWDER, amount: '2 tsp', unit: '', additionalDetails: '', section: DRY_CAKE_BATTER },
        { ...CORNSTARCH, amount: '1 tsp', unit: '', additionalDetails: '', section: DRY_CAKE_BATTER },
        { ...SALT, amount: '1/2 tsp', unit: '', additionalDetails: '', section: DRY_CAKE_BATTER },
        { ...BUTTERMILK, amount: '1/2 c', unit: '', additionalDetails: '', section: DRY_CAKE_BATTER },

        { ...WHITE_SUGAR, amount: '1/4 c', unit: '', additionalDetails: '', section: CINNAMON_SWIRL_SECTION },
        { ...CINNAMON, amount: '1 1/2 tsp', unit: '', additionalDetails: '', section: CINNAMON_SWIRL_SECTION },

        { ...UNSALTED_BUTTER, amount: '10 Tbsp', unit: '', additionalDetails: 'melted but cooled', section: STREUSEL_SECTION },
        { ...ALL_PURPOSE_FLOUR, amount: '1 1/3 c', unit: '', additionalDetails: '', section: STREUSEL_SECTION },
        { ...BROWN_SUGAR, amount: '1 c + 2 Tbsp', unit: '', additionalDetails: '', section: STREUSEL_SECTION },
        { ...WHITE_SUGAR, amount: '3 Tbsp', unit: '', additionalDetails: '', section: STREUSEL_SECTION },
        { ...CINNAMON, amount: '4 1/2 tsp', unit: '', additionalDetails: '', section: STREUSEL_SECTION },
        { ...SALT, amount: '1/4 tsp', unit: '', additionalDetails: '', section: STREUSEL_SECTION },

        { ...POWDERED_SUGAR, amount: '1/2 c', unit: '', additionalDetails: '', section: GLAZE_SECTION },
        { ...MILK, amount: '2 - 3 tsp', unit: '', additionalDetails: '', section: GLAZE_SECTION },
    ],
    appliances: [
        { name: 'oven' },
        { name: 'stand mixer' },

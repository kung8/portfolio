...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-11-19 22:42:15',
    modifiedAt: '2026-06-02 22:04:26',
    ...
    directions: [
        ...
        { step: `Transfer milk to a bowl in a stand mixer.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Add yeast, egg, yolk, sugar, and melted butter. Mix.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Add flour and salt. Mix until it forms a dough.`, section: SECTIONS.MAKE_DOUGH, img: rolls1 },
        { step: `Attach the dough hook and knead the dough on medium speed for 8 minutes. It should form a ball and be only slightly sticky. If it's too sticky (i.e. sticking to the bottom of the mixer), add up to 2 tablespoons of bread flour.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Oil a mixing bowl, transfer dough.`, section: SECTIONS.MAKE_DOUGH },

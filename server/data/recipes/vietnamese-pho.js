...
module.exports = {
    ...
    ingredients: [
        ...
        { name: 'onion', amount: '1', additionalDetails: 'sliced', optional: false, section: MAIN },
        ...
        { name: 'cilantro', amount: '', additionalDetails: 'sliced', optional: true, section: TOPPINGS },
        { name: 'green onion', amount: '', additionalDetails: 'sliced', optional: true, section: TOPPINGS },
        { name: 'bean sprout', amount: '', additionalDetails: '', optional: true, section: TOPPINGS },
        { name: 'mint', amount: '', additionalDetails: 'plucked', optional: true, section: TOPPINGS },
        { name: 'lime juice', amount: '', additionalDetails: 'sliced', optional: true, section: TOPPINGS },
        { name: 'soy sauce', amount: '', additionalDetails: '', optional: true, section: TOPPINGS },
        { name: 'sriracha sauce', amount: '', additionalDetails: '', optional: true, section: TOPPINGS },
    ],
    supplies: [
        { name: 'stove' },
    ...
    directions: [
        { step: 'Over high heat, place beef, broth, salt and pepper in a large pot and bring to a boil. Cover with a lid.', type: MAIN },
        { step: 'Add the onion to the pot.', type: MAIN },

...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...VEGETABLE_OIL, amount: '1 Tbsp', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...GROUND_PORK, amount: '6 oz', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...LIGHT_SOY_SAUCE, amount: '2 tsp', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...DARK_SOY_SAUCE, amount: '1 tsp', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...OYSTER_SAUCE, amount: '1 Tbsp', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...SESAME_OIL, amount: '1/4 tsp', additionalDetails: '', section: MINCED_MEAT_SECTION },
        { ...WHITE_PEPPER, amount: '1/4 tsp', additionalDetails: '', section: MINCED_MEAT_SECTION },

        { ...CHOW_MEIN_NOODLES, amount: '8 oz', additionalDetails: '', section: NOODLE_SECTION },
        // { ...CHAR_SIU, amount: '', additionalDetails: '', section: NOODLE_SECTION },
        { ...BABY_BOK_CHOY, amount: '2 stalks', additionalDetails: '', section: BOK_CHOY_SECTION },

        { ...LIGHT_SOY_SAUCE, amount: '1 1/2 Tbsp', additionalDetails: '', section: SAUCE_SECTION },
        { ...OYSTER_SAUCE, amount: '1/2 Tbsp', additionalDetails: '', section: SAUCE_SECTION },
        { ...ONION_POWDER, amount: '2 tsp', additionalDetails: '', section: SAUCE_SECTION },

        { ...GREEN_ONIONS, amount: '2 Tbsp', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...FRIED_SHALLOTS, amount: '2 Tbsp', additionalDetails: '', section: SECTIONS.TOPPINGS },
        { ...GARLIC, amount: '1 Tbsp', additionalDetails: 'browned and minced', section: SECTIONS.TOPPINGS },
        { ...THAI_CHILI_PEPPERS, amount: '', additionalDetails: 'sliced', section: SECTIONS.TOPPINGS },
    ],
    appliances: [
        { name: 'stove' },
    ],

...
const roastedPorkBelly = require('./roasted-pork-belly');

const MINCED_MEAT_SECTION = 'Minced Meat';
const ROASTED_PORK_BELLY_SECTION = 'Roasted Pork Belly';
...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2025-02-28 23:57:20',
    modifiedAt: '2026-06-07 23:25:41',
    ...
    directions: [
        ...
        { step: `Drain. Set the noodles on a plate.`, section: SECTIONS.COOK_NOODLES },
        ...
        { step: `Drain. Set aside.`, section: COOK_BOK_CHOY },
    ...
    notes: [
        { note: `Fresh chow mein noodles is preferred but you can use dried noodles.` },
        { note: `Choose your form of protein: minced pork or roasted pork belly.` },
    ],
    store: [
        {

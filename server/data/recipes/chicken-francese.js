...
module.exports = {
    ...
    directions: [
        { step: 'Prepare dredging stations: (1) flour and (2) eggs.', type: COOK_CHICKEN },
        { step: 'Dredge chicken in flour. Shake excess off.', type: COOK_CHICKEN },
        { step: 'Dredge into egg. Let excess drip.', type: COOK_CHICKEN },
        { step: 'Dredge in flour again.', type: COOK_CHICKEN },
        { step: 'Line a plate with paper towel.', type: COOK_CHICKEN },
        { step: 'Over medium heat, heat oil in a pan.', type: COOK_CHICKEN },
        { step: 'Add chicken and saute until almost cooked through (about 4 minutes per side).', type: COOK_CHICKEN },
        { step: 'Transfer to the plate.', type: COOK_CHICKEN },
        { step: 'Preheat oven to 300ºF.', type: PREP_SAUCE },
        { step: 'Over medium-low heat, combine the "Sauce" section ingredients.', type: PREP_SAUCE },
        { step: 'Cook until butter melts, stirring occasionally.', type: PREP_SAUCE },
        { step: 'In a small bowl, combine cornstarch and water.', type: PREP_SAUCE },
        { step: 'Add cornstarch mixture to the saucepan. Cook until slightly thickens (about 2 to 3 minutes).', type: PREP_SAUCE },
        { step: 'Add chicken and sauce to the baking dish.', type: BAKE_CHICKEN },
        { step: 'Bake until the chicken is no longer pink and juices are clear (about 10 to 15 minutes).', type: BAKE_CHICKEN },
        { step: 'Enjoy this dish.', type: SECTIONS.SERVE },
    ]
};
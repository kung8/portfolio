...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-12-08 19:13:20',
    modifiedAt: '2026-02-21 14:38:40',
    ...
    directions: [
        { step: `In a mixing bowl, combine the "Filling" ingredients.`, section: SECTIONS.FILLING },
        { step: `Halve the tomatoes. With a spoon, cut out the tomato cores.`, section: SECTIONS.SAUCE },
        { step: `Place the cores and skins in two separate medium bowls.`, section: SECTIONS.SAUCE },
        ...
        { step: `Rub the cornstarch with your fingers.`, section: TOMATOES_SECTION },
        { step: `Tightly pack the filling into each tomato skin.`, section: TOMATOES_SECTION, img: tomatoes1 },
        ...
        { step: `Place the stuffed tomatoes, meat-side down, in the pan. Cook until the meat has browned but not burned (about 3 to 4 minutes).`, section: SECTIONS.MAIN, img: tomatoes2 },
        { step: `Flip the stuffed tomatoes. Let it cook for 2 minutes.`, section: SECTIONS.MAIN, img: tomatoes3 },
        { step: `Flip the stuffed tomatoes back over.`, section: SECTIONS.MAIN },
        { step: `Add the sauce. Make sure the meat is submerged in the sauce.`, section: SECTIONS.MAIN, img: tomatoes4 },
        ...
        { step: `In a small bowl, combine the water and cornstarch.`, section: SECTIONS.MAIN },
        { step: `Add this thickening mixture to the sauce. Mix until it has incorporated into the sauce and the sauce has thickened.`, section: SECTIONS.MAIN },
        { step: `Pour sauce over the stuffed tomatoes and top with green onions. Enjoy this simple Southeast Asian cuisine with some jasmine rice.`, section: SECTIONS.SERVE, img: tomatoes6 },
    ],
    notes: [
        { note: `The firmer the tomato, the better. I recently found the Beefsteak tomatoes which were perfect for this recipe.`},
        { note: `Halve the tomatoes horizontally since it's easier to pack the filling into the tomato skins.` },
    ],
    store: [
        {

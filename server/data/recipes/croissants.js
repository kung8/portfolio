...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...MILK, amount: '1 1/2 c', additionalDetails: 'lukewarm', section: DOUGH_SECTION },
        { ...BROWN_SUGAR, amount: '1/4 c', additionalDetails: '', section: DOUGH_SECTION },
        { ...YEAST, amount: '3 1/4 tsp', additionalDetails: '', section: DOUGH_SECTION },
        { ...ALL_PURPOSE_FLOUR, amount: '3 1/4 c', additionalDetails: '', section: DOUGH_SECTION },
        { ...SALT, amount: '1 Tbsp', additionalDetails: '', section: DOUGH_SECTION },
        { ...UNSALTED_BUTTER, amount: '1 1/2 c', additionalDetails: '', section: BUTTER_SECTION },
        { ...EGGS, amount: '1', additionalDetails: '', section: EGG_WASH_SECTION },
    ],
    appliances: [
        { name: 'stand mixer' },
        { name: 'oven' },

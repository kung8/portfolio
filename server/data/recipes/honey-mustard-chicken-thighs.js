...
module.exports = {
    ...
    directions: [
        { step: `In a mixing bowl, combine together the "${SECTIONS.MARINADE}" section ingredients until smooth.`, section: SECTIONS.MARINATE },
        { step: `Add chicken. Mix until coated.`, section: SECTIONS.MARINATE },
        { step: `Let it marinate for 2 hours (or overnight).`, section: SECTIONS.MARINATE },

...
module.exports = {
    ...
    available: true,
    recommended: false,
    createdAt: '2024-04-02 23:59:47',
    modifiedAt: '2026-05-02 15:07:36',
    ...
    directions: [
        ...
        { step: `Marinate chicken for 15 minutes.`, section: SECTIONS.MARINATE_CHICKEN },

        { step: `Place chicken in a circle.`, section: SECTIONS.COOK_CHICKEN, img: wings1 },
        { step: `In mixing bowl, combine the "${SECTIONS.SAUCE}" section ingredients.`, section: SECTIONS.COOK_CHICKEN },
        ...
        { step: `Add the "${CONDIMENTS_SECTION}" section ingredients. Stir.`, section: ADD_CONDIMENTS, img: wings2 },

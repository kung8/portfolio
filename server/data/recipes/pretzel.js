...
module.exports = {
    ...
    available: true,
    recommended: false,
    createdAt: '04/20/2024 20:16:36',
    modifiedAt: '06/04/2026 20:36:38',
    ...
    directions: [
        ...
        { step: `Whisk in salt, brown sugar, and melted butter into mixer.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Add 3 cups of flour into the mix, one at a time.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Continue to mix until the dough is no longer sticky. Add 3/4 to 1 cup of flour to help with the stickiness.`, section: SECTIONS.MAKE_DOUGH },
        { step: `Once that is ready, continue mixing for a few more minutes (or you can knead the dough).`, section: SECTIONS.MAKE_DOUGH },
        { step: `Form the dough into a ball.`, section: SECTIONS.MAKE_DOUGH },
        ...
        { step: `Roll each dough ball into 20"-22" ropes on a clean counter.`, section: SECTIONS.MAIN, img: pretzel1 },
        { step: `Form the pretzel shape by holding the ends of the rope and crossing the ends as if tying your shoe. Then twist slightly with your right hand so it comes around the other side and place the two rope ends over the bottom of the pretzel.`, section: SECTIONS.MAIN, img: pretzel2 },
        { step: `Once all of the pretzels are created, you will carefully drop in one or two pretzels at a time into the boiling water. And let each of the pretzels sit in the water for 20 to 30 seconds.`, section: SECTIONS.MAIN, img: pretzel3 },
        { step: `Remove each pretzel with a slotted spatula and let the excess water drain.`, section: SECTIONS.MAIN, img: pretzel4 },
        { step: `Place on the baking sheet and sprinkle coarse salt as desired.`, section: SECTIONS.MAIN, img: pretzel5 },
        
        { step: `Bake for 12 to 15 minutes, or until they are golden brown.`, section: SECTIONS.BAKE },
    ],
    store: [
        {

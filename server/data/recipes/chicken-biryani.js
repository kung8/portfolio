...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-09-11 21:22:29',
    modifiedAt: '2026-05-31 20:50:58',
    ...
    directions: [
        { step: `In a large pot, mix the "${SECTIONS.MARINADE}" ingredients.`, section: SECTIONS.MARINATE_CHICKEN },
        { step: `Add chicken to the marinade and coat the chicken. Marinate for at least 20 minutes to overnight.`, section: SECTIONS.MARINATE_CHICKEN },

        { step: `Over medium-high heat, bring 3 liters of water to boil.`, section: SECTIONS.COOK_RICE },
        { step: `Add salt and whole spices to the water.`, section: SECTIONS.COOK_RICE },
        { step: `Add rice and bring to a boil.`, section: SECTIONS.COOK_RICE },
        { step: `Cook until rice is al dente (about 4 minutes).`, section: SECTIONS.COOK_RICE },
        { step: `Drain immediately and set aside. Note that the rice will be a little salty at this point but will balance out later on.`, section: SECTIONS.COOK_RICE },
        ...
        { step: `Add onion and cook until golden brown (don't burn or it will be bitter). Cook in batches as needed.`, section: SAUTE_ONION },
        { step: `Place the onions on the paper towel lined plate to drain off some of the oil.`, section: SAUTE_ONION },

        { step: `In a bowl, soak the saffron threads in the warm water.`, section: PREP_SAFFRON_WATER, img: biryani1 },
    
        { step: `Over medium heat, cover with lid and cook the pot of chicken for 5 minutes.`, section: COOK_BIRYANI },
        { step: `Uncover and cook for 5 minutes, turning chicken twice.`, section: COOK_BIRYANI },
        { step: `Remove from heat.`, section: COOK_BIRYANI },
        { step: `Arrange the chicken in the pot with the skin side down.`, section: COOK_BIRYANI, img: biryani2 },
        { step: `Add half of the sauteed onions and half of the cilantro.`, section: COOK_BIRYANI, img: biryani3 },
        { step: `Add the cooked rice and gently flatten.`, section: COOK_BIRYANI, img: biryani4 },
        { step: `Top with saffron.`, section: COOK_BIRYANI, img: biryani5 },
        { step: `Drizzle with ghee.`, section: COOK_BIRYANI, img: biryani6 },

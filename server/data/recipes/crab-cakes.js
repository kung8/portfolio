...
module.exports = {
    ...
    directions: [
        { step: 'In a medium bowl, combine the "Sauce" section ingredients.', type: MARINATE_CRAB },
        { step: 'In a mixing bowl, toss the crab together with the crushed saltines.', type: MARINATE_CRAB },
        { step: 'Fold in mayo mixture and stir. Cover and refrigerate for 1 hour.', type: MARINATE_CRAB },
        { step: 'Form 1 1/2 inch thick patties (about 1/3 cup).', type: COOK_CRAB_CAKES },
        { step: 'Over medium-high heat, heat oil in a large pan.', type: COOK_CRAB_CAKES },
        { step: 'Add crab cakes. Cook until golden and cooked through (about 3 minutes per side).', type: COOK_CRAB_CAKES },
        { step: 'Serve with lemon wedges. You no longer need to wait for a fancy party invitation to enjoy these hors d\'oeuvres.', type: SECTIONS.SERVE },
    ]
};
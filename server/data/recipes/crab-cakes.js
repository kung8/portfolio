...
const { CRAB, DIJON_MUSTARD, EGG, HOT_SAUCE, LARGE_PAN, LEMON, MAYONNAISE, MEDIUM_BOWL, MIXING_BOWL, SALTINES, STOVE, VEGETABLE_OIL, WORCESTERSHIRE_SAUCE } = require('./ingredients');
...
module.exports = {
    ...
    allergies: [ALLERGIES.EGG, ALLERGIES.SHELLFISH],

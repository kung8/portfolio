...
const { ALL_PURPOSE_FLOUR, BAKING_PAN, BROWN_SUGAR, COOLING_RACK, CORNSTARCH, EGG, GARLIC_SALT, GREEN_BELL_PEPPER, KETCHUP, LARGE_POT, LIGHT_SOY_SAUCE, MIXING_BOWL, PAPER_TOWELS, PINEAPPLE, PORK_SHOULDER, RED_BELL_PEPPER, RED_ONION, SALT, SPIDER_STRAINER, STOVE, VEGETABLE_OIL, WATER, WHITE_VINEGAR, WOK, YELLOW_BELL_PEPPER, YELLOW_ONION } = require('./ingredients');
...
module.exports = {
    ...
    available: true,
    recommended: true,
    createdAt: '2024-12-09 22:58:38',
    modifiedAt: '2026-01-01 21:07:04',
    ...
    directions: [
        ...
        { step: `Carefully add the pork to the hot oil and fry until pork starts to brown and gets crispier (about 7 to 8 minutes). Once in the oil, avoid disrupting the pieces to prevent the coating from coming off.`, section: DEEP_FRY },

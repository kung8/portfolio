...
const { LIGHT_SOY_SAUCE, EGGS, ALL_PURPOSE_FLOUR, CORNSTARCH, PORK_SHOULDER, GARLIC_SALT, KETCHUP, BROWN_SUGAR, WHITE_VINEGAR, SALT, COLD_WATER, RED_BELL_PEPPERS, YELLOW_BELL_PEPPERS, GREEN_BELL_PEPPERS, RED_ONION, SMALL_YELLOW_ONION, PINEAPPLE, VEGETABLE_OIL } = require('./ingredients');
...
module.exports = {
    ...
    separated: true,
    ingredients: [
        { ...GARLIC_SALT, amount: '2 tsp', additionalDetails: '', section: PORK_MARINADE },
        { ...LIGHT_SOY_SAUCE, amount: '2 Tbsp', additionalDetails: '', section: PORK_MARINADE },
        { ...EGGS, amount: '1', additionalDetails: '', section: PORK_MARINADE },
        { ...ALL_PURPOSE_FLOUR, amount: '4 Tbsp', additionalDetails: '', section: PORK_MARINADE },
        { ...CORNSTARCH, amount: '6 Tbsp', additionalDetails: '', section: PORK_MARINADE },
        { ...PORK_SHOULDER, amount: '1.25 lb', additionalDetails: 'cut into 1/2 inch pieces', section: PORK_MARINADE },
        
        { ...KETCHUP, amount: '1/2 c', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        { ...BROWN_SUGAR, amount: '1/2 c', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        { ...WHITE_VINEGAR, amount: '6 Tbsp', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        { ...CORNSTARCH, amount: '2 tsp', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        { ...SALT, amount: '1 tsp', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        { ...COLD_WATER, amount: '4 Tbsp', additionalDetails: '', section: SWEET_AND_SOUR_SAUCE },
        
        { ...RED_BELL_PEPPERS, amount: '1/4', additionalDetails: 'chopped', section: FRUIT_AND_VEGGIES },
        { ...YELLOW_BELL_PEPPERS, amount: '1/4', additionalDetails: 'chopped', section: FRUIT_AND_VEGGIES },
        { ...GREEN_BELL_PEPPERS, amount: '1/4', additionalDetails: 'chopped', section: FRUIT_AND_VEGGIES },
        { ...RED_ONION, amount: '1/2 small', additionalDetails: 'chopped', section: FRUIT_AND_VEGGIES },
        { ...SMALL_YELLOW_ONION, amount: '1/2', additionalDetails: 'chopped', section: FRUIT_AND_VEGGIES },
        { ...PINEAPPLE, amount: '8 oz', additionalDetails: 'chunk sized', section: FRUIT_AND_VEGGIES },

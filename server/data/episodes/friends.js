const friends = [
    ...
    },
    {
        season: 5,
        episode: 3,
        title: 'The One With The Triplets, aka The One Hundredth',
    ...
    },
    {
        ...
        plot: 'The day after the wedding, everyone checks out of the hotel.Ross, always wanting to get his money\'s worth, won\'t check out until the last minute.Thanks to Joey, there are unexpected food and porn charges on several bills.Chandler forgot to make sure the disposable cameras were gathered after the reception, so he and Ross attend another wedding at the same location, to fake the photos(including one of Chandler kissing a different brunette bride).Monica can\'t wait for Chandler\'s return, so she opens all the wedding gifts without him.Joey, thinking that Phoebe is pregnant, proposes marriage and she accepts.Later, when he learns it\'s Rachel, he proposes to her. She doesn\'t accept.Joey remembers Rachel had someone spend the night a month earlier, who left behind a red sweater.Phoebe thinks it belongs to Tag, Rachel\'s old boyfriend; but he\'s not missing a red sweater.Later, Ross sees the sweater on the table.He picks it up and announces he\'s been looking for it for a month.',
    },
    {
        season: 8,
        episode: 3,
        title: 'The One Where Rachel Tells...',
        plot: 'Chandler and Monica go on their honeymoon.Everywhere they go, another honeymooning couple beats them to the last of the free newlywed upgrades.Rachel prepares to tell Ross that he\'s the father of his child. Joey and Phoebe realize neither of them have keys to Chandler and Monica\'s apartment.Phoebe needs her guitar and Joey wants food, so they call the superintendent saying there\'s a gas leak. Mr. Treeger has the door broken down. Rachel tells Ross, and he and Joey learn that condoms are not 100% effective. Rachels gets a sonogram but can\'t tell where the baby is.',
    },
    {
        season: 8,
        episode: 4,
        title: 'The One With The Video Tape',

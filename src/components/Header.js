...
const Header = props => {
    ...
    const addScrollEventListener = () => {
        ...
        window.addEventListener('scroll', () => {
            let page = document.querySelector('.projects-page') || document.querySelector('.contact-page') || document.querySelector('.resume-page') || document.querySelector('.music-page') || document.querySelector('.about-page') || document.querySelector('.components-page');

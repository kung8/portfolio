...
const MiniGames = {id:6, name:'MiniGames',url:null, tech:['React-Native','React-Navigation','Toast'], image:[cards,I,de,clare,War,victory,war,blackjack,ttt],desc:'First React-Native app to build a mini game platform',date: 'July 2019', hosted: false ,lessons:"Learned differences in React-Native and built own logic for game play."}

class Projects extends Component {
    constructor() {
        super()
        this.state = {
            projects: [MiniGames,Chatterbox,DeadStock,MarketIn,Helo,Houser],
            isBlueSelected: true,

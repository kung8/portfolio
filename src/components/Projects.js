...
const DeadStock = { id: 4, name: 'DeadStock', url: '159.65.98.93:8080', tech: ['Sockets', 'Material-UI', 'AWS S3'], image: [deadstock,community,chatlist,favorites,friends,profile], desc: 'A shoe collection social media SPA', domain: false, date: 'Apr 2019', hosted: true ,lessons:"This group project was an incredible experience. I was blessed to work with Joseph Hamblin, Matias Perez, and Samantha Jeet. I learned a ton about working with others especially having to interact with different ways of coding and how to adapt with my own way of coding. There were differences in styling and coding methods but we learned to trust each other getting it done. This was my first full-stack app completed in a team. I used most of the same technologies from previous projects but had a chance to further dive into Amazon S3 and Sockets.io. I took ownership of the image uploads and the chat functionality. I enjoyed learning Chartjs which working with the data was a little tricky. "}
const ChatterBox = { id: 5, name: 'ChatterBox', url: 'thechatterbox.fun', tech: ['Sockets', 'Styled-Components'], image: [chatterbox,sidebar,alllist,editgroup,editprofile,indchat,loginchat,otherprofile,searchuser], desc: 'SPA chat app to connect individuals and groups to practice real-live updates', domain: true, date: 'Jun 2019', hosted: true ,lessons:"Some valuable things that I learned from this project was Sockets cannot be invoked in multiple components and Styled-Components rock! There were issues with my chat functionality initially due to its unexpected behavior of establishing three separate socket instances so it was not sending the message to the proper connection."}

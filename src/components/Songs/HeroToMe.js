        ...
        <>
            ...
            <div className="music-card">
                ...
                <p>
                    ...
                    <span className="p-rel">Of<span className="p-abs beginning">D/F#</span></span> pillow talks <span className="p-rel">through<span className="p-abs beginning">C</span></span> the <span className="p-rel">night.<span className="p-abs beginning">G</span></span><br /><br />
                    <span className="p-rel">Adventures<span className="p-abs beginning">C</span></span> always <span className="p-rel">stirring<span className="p-abs beginning">D/F#</span></span><br /><br />
                    ...
                    <span className="p-rel">Our<span className="p-abs beginning">G</span></span> laughs and <span className="p-rel">jokes<span className="p-abs beginning">C</span></span> and <span className="p-rel">scares<span className="p-abs beginning">D/F#</span></span> we <span className="p-rel">had.<span className="p-abs beginning">C</span></span><br /><br />
                    Of <span className="p-rel">trees<span className="p-abs beginning">G</span></span> <span className="p-rel">falling<span className="p-abs beginning">C</span></span> <span className="p-rel">down.<span className="p-abs beginning">D/F#</span></span><br /><br />
                    Our <span className="p-rel">basement<span className="p-abs beginning">G</span></span> <span className="p-rel">creaks<span className="p-abs beginning">C</span></span> and <span className="p-rel">haunts<span className="p-abs beginning">D/F#</span></span> us <span className="p-rel">still<span className="p-abs beginning">C</span></span><br /><br />
                    We'd <span className="p-rel">run<span className="p-abs beginning">F</span></span> without a <span className="p-rel">sound<span className="p-abs beginning">D/F#</span></span>
                </p>
                <p>
                    ...
                    <span className="p-rel">Grow<span className="p-abs beginning">G</span></span> fonder in my <span className="p-rel">heart.<span className="p-abs beginning">D/F#</span></span><br /><br />
                ...
                <p>
                    ...
                    <span className="p-rel">Most<span className="p-abs beginning">G</span></span> days <span className="p-rel">we<span className="p-abs beginning">C</span></span> got <span className="p-rel">along<span className="p-abs beginning">D/F#</span></span><br /><br />
                    ...
                    <span className="p-rel">Tickle<span className="p-abs beginning">G</span></span> fights <span className="p-rel">that<span className="p-abs beginning">C</span></span> end in <span className="p-rel">line<span className="p-abs beginning">D/F#</span></span><br /><br />

        ...
        <>
            ...
            <div className="music-card">
                ...
                <p>
                    ...
                    <span className="p-rel">I'm<span className="p-abs beginning">G</span></span> still <span className="p-rel">searching<span className="p-abs beginning">X</span></span> for you<br /><br />
                    ...
                    <span className="p-rel">You<span className="p-abs beginning">G</span></span> keep my head up, <span className="p-rel">not<span className="p-abs beginning">X</span></span> giving in<br /><br />
                    ...
                    <span className="p-rel">I<span className="p-abs beginning">G</span></span> thought it'd work out <span className="p-rel">time<span className="p-abs beginning">X</span></span> and again<br /><br />
                    ...
                    <span className="p-rel">Driven<span className="p-abs beginning">G</span></span> to learn from <span className="p-rel">all<span className="p-abs beginning">X</span></span> my mistakes<br /><br />
                ...
                <p>
                    ...
                    <span className="p-rel">I<span className="p-abs beginning">G</span></span> can change, <span className="p-rel">give<span className="p-abs beginning">X</span></span> me another <span className="p-rel">shot<span className="p-abs beginning">Cadd9</span></span><br /><br />
                    I'd give it all, <span className="p-rel">all<span className="p-abs beginning">D</span></span> I've got.<br /><br />
                    <span className="p-rel">All<span className="p-abs beginning">G</span></span> this regret <span className="p-rel">lingers<span className="p-abs beginning">X</span></span> there,<br /><br />
                ...
                <p>
                    ...
                    <span className="p-rel">Struggle<span className="p-abs beginning">G</span></span> to keep my <span className="p-rel">heart<span className="p-abs beginning">X</span></span> from the burn<br /><br />

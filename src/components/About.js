        ...
        <div className="about-page flex" style={{ backgroundImage: `url(${bako})` }}>
            <div className="about-inner-container justify-around set-top align-ctr">
                <p className="about-me-summary">
                    My name is Kevin Ung. I am a software engineer. I love serenading my neighborhood, watching Disney+, learning about various subjects, the sense of accomplishment after a good run or bike ride, cooking/baking a new delicious recipe, and casual tosses of Frisbee or Lacrosse.
                </p>
                <div className="about-me-container wrap">
                    ...
                    <div onClick={() => history.push('/resume')} className="icon-container">
